    ...
    MultipleSelect.prototype = {
        ...
        init: function () {
            ...
            if (this.options.filter) {
                this.$drop.append([
                    '<div class="ms-search">',
                    '<input type="text" autocomplete="off" autocorrect="off" autocapitilize="off" spellcheck="false" placeholder="Search....">',
                    '</div>'].join('')
                );
            }
        ...
        optionToHtml: function (i, elm, group, groupDisabled) {
            ...
            if ($elm.is('option')) {
                ...
                $el = $([
                    ...
                    sprintf('<label class="%s" title="'+text+'">', disabled ? 'disabled' : ''),
