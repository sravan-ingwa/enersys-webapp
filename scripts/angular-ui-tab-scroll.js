        ...
        return {
          ...
          template: [
            '<div class="ui-tabs-scrollable" ng-class="{\'show-drop-down\': !hideDropDown}">',
              ...
              ' ng-disabled="disableLeft" class="btns nav-button left-nav-button"' +
              ...
              ' ng-disabled="disableRight" class="btns nav-button right-nav-button"' +
              ' tooltip-placement="{{tooltipRightDirection}}" uib-tooltip-html="tooltipRightHtml"></button>',
              '<div class="btns-group" ng-class="::dropDownClass" uib-dropdown dropdown-append-to-body ng-hide="hideDropDown">',
                '<button type="button" class="btns" uib-dropdown-toggle></button>',
          ...
          link: function($scope, $el) {
            ...
            $scope.api = {
              ...
              scrollTabIntoView: function(arg){
                $timeout(function(){$scope.scrollTabIntoView(arg)},300);
              }
            };
