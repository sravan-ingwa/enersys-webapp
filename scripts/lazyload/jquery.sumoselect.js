        ...
        var ret = this.each(function () {
            ...
            this.sumo = {
                ...
                createElems: function () {
                    ...
                    O.select = O.E.parent();
                    O.caption = $('<span></span>');
                    O.CaptionCont = $('<p class="CaptionCont"><label><i class="caret"></i></label></p>').addClass('SlectBox').attr('style', O.E.attr('style')).prepend(O.caption);
                    ...
                    //## Creating the list...
                    O.optDiv = $('<div class="optWrapper"><input type="text" class="textSearch" placeholder="Search...">');
                ...
                createLi: function (opt,i) {
                    ...
                    li = $('<li data-val="' + opt.val() + '"><label title="'+opt.text()+'">' + (opt.text()) + '</label></li>');
                ...
                selAll:function(){
                    ...
                    O.chkAll.on('click',function(){
                        ...
                        O.optDiv.find('ul.options li').each(function(ix,e){
                            e = $(e);
                            if(O.selAll.hasClass('selected')){if(!e.hasClass('selected'))e.trigger('click');}
...
//                                O.hideOpts();
                ...
                setOnOpen: function () {
                    ...
                    var li = O.optDiv.find('ul li:first').eq(O.E[0].selectedIndex);
                    li.addClass('sel');
                    O.showOpts();
                },
                /*nav: function (up) {
				...
				nav: function (up) {
                    ...
                    if (O.is_opened && sel.length) {
                        if (up)
                            c = sel.prevAll('li:not(".disabled, .hidden")');
                        else
                            c = sel.nextAll('li:not(".disabled, .hidden")');
                        if (!c.length)return;
                        sel.removeClass('sel');
                        sel = c.first().addClass('sel');
                ...
                setText: function () {
                    ...
                    //set display text
                    O.caption.text((O.placeholder.length > 14 ? O.placeholder.slice(0,14)+'..' : O.placeholder));
