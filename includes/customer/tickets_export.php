...
<div class="modal-style" ng-controller="fromToDateCtrl">	<!-- wrapper for specific style -->
	...
	<div class="modal-body" ng-controller="addingform">
		...
		<form class="form-horizontal forms_add" name="ticketsexportForm" data-went="#/tickets" method="post" url="services/customer/ticket_export" ng-submit="sendPost()" novalidate>
