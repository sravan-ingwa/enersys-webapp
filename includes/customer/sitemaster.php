...
<div ng-controller="SiteMasterCustCtrl">
	<div ng-controller="mul_view_form">
    	<div class="panel panel-lined table-responsive panel-hovered mb10">
            ...
            <ol class="breadcrumb breadcrumb-small right" style="margin-bottom:0px;">
                <li><a href="" ng-click="sitemastercustexrtOpen()" class="padding-10 export-btn">Export</a></li>
            </ol>
       </div>
		<!-- row -->
		<div class="row">
            ...
            <div class="panel panel-default">
              <form class="form-horizontal forms_ec" url="services/customer/sitemaster_mul_view" name="userForm" method="post">
                        ...
                        <tr>
                           ...
                           <!--<th class="hidden-xs hidden-sm">
                            ...
                            <!--<th>
                                ...
                                <input type="text" class="droptxt1 hidden form-control" name="siteStatus" placeholder="Type keyword" data-ng-keyup="listSorting()">
                                <span class="ion ion-ios-close-outline inptClose hidden" data-ng-click="listSorting()"></span>
                            </th>-->
        ...
        <div class="sidebar-wrap text-uppercase mt47">
            	...
            	<div class="panel-body clearfix freez-panel">
                    ...
                    <div class="row tkt-panel">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4">
                          <h6>Second Level Contact Email ID</h6>
