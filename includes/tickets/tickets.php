...
<div class="page page-ui-extras" ng-controller="ModalDemoCtrl">
	<div ng-controller="ticketCtrl as main">
    ...
    <div ng-controller="mul_view_form">
			...
			<div class="col-md-12 table-height">
				<div class="panel panel-lined table-responsive panel-hovered" style="overflow-x:hidden">
					<div class="panel panel-default">
						<form class="form-horizontal forms_ec" url="services/tickets/ticket_mul_view" name="userForm" method="post" novalidate>
							<table class="table table-condensed">
								<thead>
									<tr>
                                        ...
                                        <th ng-controller="leveldropCntrl" width="120px">
                                        ...
                                        <th class="hidden-xs hidden-sm">
                                            <a class="tktid">Visits&nbsp;<span class="arrow caret"></span></a>
                                            <input type="text" class="droptxt1 hidden form-control" name="visits" placeholder="Type keyword" data-ng-keyup="listSorting()"  />
                                            <span class="ion ion-ios-close-outline inptClose hidden" data-ng-click="listSorting()"></span>
                                        </th>
                                        <th>
                                        ...
                                        <th class="hidden-xs hidden-sm" style="width:150px" ng-if="datas.mapping || datas.advEdit || datas.delete">
                                            Actions
                                        </th>
									</tr>
								</thead>
								...
								<table class="table table-condensed table-hover">
									<tbody>
                                        <tr class="tktBackground" ng-repeat="data in datas.ticketDetails" >
                                            ...
                                            <td class="hidden-xs hidden-sm"><span tooltip-placement="top" tooltip="{{data.customer_name}}">{{data.customer_code | limitTo:10}}{{data.customer_code.length>12 ? '...':''}}</span></td>
											...
											<td class="hidden-xs hidden-sm">{{data.visits}}</td>
                                            ...
                                            <td class="hidden-xs hidden-sm" style="width:150px"  ng-if="datas.mapping || datas.advEdit || datas.delete">
                                    <a href="javascript:void(0)" class="ml3" tooltip="e-FSR Mapping" 
                                    tooltip-placement="bottom" ng-click="efsrEdit(data.ticket_alias);"  ng-if="datas.mapping">
                                        <span class="fa fa-copy"></span>
                                    </a>
                                    <a href="" class="ml3" tooltip="Advance Edit" tooltip-placement="bottom" ng-click="advEdit(data.ticket_alias);" ng-if="datas.advEdit">
                                        <span class="fa fa-spl-edit"></span>
                                    </a>
                                    <a href="javascript:void(0)" class="ml3" tooltip="Delete Ticket/Esfr" 
                                    tooltip-placement="bottom" ng-click="delTicket(data.ticket_alias);" ng-if="datas.delete">
		...
		<div ng-if="datas.add"><button type="button" class="btn btn-info ion ion-plus compose-btn" tooltip="Add New" tooltip-placement="top"  ng-click="ticketOpen()" md-ink-ripple></button></div>
		</div>
        </div>
     <div id="ticketviesw" ng-controller="addingform1">
			...
			<div class="sidebar-wrap text-uppercase">	
				<div class="group clearfix head tkt-heading2">
					...
					<div class="right">	
						<div class="btn-group btn-group-sm">
                            <a href="" ng-if="(level_code!=5 && level_code!=6 && level_code!=7 && singleViews.edit) || deposition_edit" class="ml10" tooltip="Edit" tooltip-placement="left" ng-click="ticketseditOpen()"><span class="fa fa-edit"></span></a>
                            <a href="services/tickets/tickets_print.php?alias={{ticket_alias}}" tooltip="Print" class="ml10" tooltip-placement="left"><span class="ion ion-android-print"></span></a>
                            <a href="services/tickets/tickets_download.php?alias={{ticket_alias}}" target="_blank" tooltip="Download" class="ml10" tooltip-placement="left"><span class="ion ion-android-download"></span></a>
							<a href="" class="ml10 popMail" tooltip="Send" tooltip-placement="left"><span class="fa fa-send"></span></a>
							<a href="services/tickets/ts_download.php?alias={{ticket_alias}}" ng-if="ts_download" target="_blank" tooltip="TS" class="ml10" tooltip-placement="left"><span class="ion ion-social-tumblr"></span></a>
						</div>
					</div>
				</div>	
				<div>
				<!--<div class="toast toast-topRight" style="z-index:100000;">
				 ...
				 <div class="sendMail">
				  <!--<div class="expLoader sendPop"><span class="loader"><img src="images/ajax-loader.gif" alt="loader" width="50" height="50"></span></div>
				 <div style="display:none" class="loader"><img src="images/ajax-loader.gif" alt="loader"></div>-->
                    <form class="form-horizontal forms_add1" id="configform" name="sendEmail" role="form" data-went="#/tickets" method="post" url="services/tickets/mail_send" ng-submit="sendPost1()" novalidate>
                        <h5 class="popTitle sendPop">Enter Email ID</h5>
                        <input type="hidden" name="mail_ticket_alias" value="{{ticket_alias}}" />
                        <div class="col-sm-12 sendPop">
                            <md-input-container flex="" class="md-default-theme sendPop">
                                <label for="input_00D">Email ID (Ex: abc@gmail.com)</label>
                                <input ng-model="Email" name="send_email" class="sendPop" ng-pattern="/^(([a-zA-Z0-9_\-\.]+)@([a-zA-Z0-9_\-\.]+)\.([a-zA-Z]{2,5}){1,25})+([;,.](([a-zA-Z0-9_\-\.]+)@([a-zA-Z0-9_\-\.]+)\.([a-zA-Z]{2,5}){1,25})+)*$/" required="required">
                            </md-input-container>
                        </div> 
                        <div class="col-sm-6 col-sm-offset-3 sendPop">
                            <button type="submit" class="btn btn-info btn-sm subdisabled sendPop" ng-disabled="sendEmail.$invalid || sendEmail.$pristine">Send</button>
                            <button type="reset" class="btn btn-info btn-sm btnCan">Cancel</button>
                        </div>  
                   </form> 
                 </div>
				 </div>
				<scrollable-tabset api="main.scrlTabsApi" tooltip-left-placement="right">
                 <tabset justified="true" class="tabs-linearrow ticket-mt46">
                    <tab active="isActive[key]" ng-style="{backgroundColor : ((tickets.purpose==0) && '#FFF') || '#FFF'}" ng-repeat="(key,tickets) in singleViews.obj" ng-init="isActive[singleViews.obj.length-1]=true;(singleViews.obj.length-1==key ? main.scrollIntoView(key) : ''); tabtickets(tickets.main_ticket_id,tickets.ticket_alias,tickets.level_code,tickets.levelcolor,tickets.level,tickets.deposition_edit,tickets.ts_download)" ng-click="tabtickets(tickets.main_ticket_id,tickets.ticket_alias,tickets.level_code,tickets.levelcolor,tickets.level,tickets.deposition_edit,tickets.ts_download)">
                      	<tab-heading>{{tickets.purpose==0 ? 'VISIT':'REPLACE'}} - {{key+1}}</tab-heading>
                        <div class="panel-body clearfix tabing-panel">
                            ...
                            <div class="row tkt-panel">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-4">
                                    ...
                                    <span class="fnt-size-11" style="word-wrap:break-word">{{tickets.manager_mail}}</span>
                                </div>
                                <div class="col-lg-4 col-md-4 col-sm-4">
                            ...
                            <div class="row tkt-panel">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-4" style="word-wrap:break-word">
                                    <h6>Site Address</h6>
                            ...
                            <div class="row tkt-panel">
                                <div class="col-lg-4 col-md-4 col-sm-4">
                                    ...
                                    <span class="fnt-size-11">{{tickets.sale_invoice_num}}</span>
                                </div>
                                <div class="col-lg-4 col-md-4 col-sm-4">
                                    <h6>Sale Invoice Date</h6>
                                    <span class="fnt-size-11">{{tickets.sale_invoice_date}}</span>
                                </div>
                                <div class="col-lg-4 col-md-4 col-sm-4">
                                    <h6>Sale PO Number</h6>
                                    <span class="fnt-size-11">{{tickets.po_num}}</span>
                                </div>
                            </div>
                            <div class="row tkt-panel" ng-if="tickets.at_check == '0' && tickets.po_number !=''">
                                <div class="col-lg-4 col-md-4 col-sm-4">
                                    <h6>Service PO Number</h6>
                                    <span class="fnt-size-11">{{tickets.po_number}}</span>
                                </div>
                                <div class="col-lg-4 col-md-4 col-sm-4">
                                    <h6>Service PO Date</h6>
                                    <span class="fnt-size-11">{{tickets.po_date}}</span>
                                </div>
                                <div class="col-lg-4 col-md-4 col-sm-4">
                                    <h6>Service PO Copy</h6>
                                    <span class="fnt-size-11" ng-if="tickets.po_link != ''">
                                        <a href="{{tickets.po_link}}" tooltip-placement="top" target="_blank" tooltip="Click here to view PO Copy file"><b>Click Here</b></a>
                                     </span>
                                    <span class="fnt-size-11" ng-if="tickets.po_link == ''">PO Copy</span>
                                </div>
                            </div>
                            <div class="row tkt-panel">
                                <div class="col-lg-4 col-md-4 col-sm-4">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-4">
                                    <h6>MOC</h6>
                                    <span class="fnt-size-11" ng-if="tickets.contact_link != ''">
                                        <a href="{{tickets.contact_link}}" tooltip-placement="top" target="_blank" tooltip="Click here to view {{tickets.mode_of_contact}} file"><b>{{tickets.mode_of_contact}}</b></a>
                                     </span>
                                    <span class="fnt-size-11" ng-if="tickets.contact_link == ''">{{tickets.mode_of_contact}}</span>
                                </div>
                                <div class="col-lg-4 col-md-4 col-sm-4">
                                    <h6>{{tickets.moc_num != '' ? tickets.mode_of_contact : 'MOC'}} Number</h6>
                                    <span class="fnt-size-11">{{tickets.moc_num != '' ? tickets.moc_num : 'NA'}}</span>
                                </div>
                            </div>
                            <div class="row tkt-panel">
                                <div class="col-lg-4 col-md-4 col-sm-4">
                            ...
                            <div class="row tkt-panel">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-4">
                                    <h6>TT Warranty</h6>
                                    <span class="fnt-size-11">{{tickets.warranty}}</span>
                                </div>
                            </div>
                            <div class="row tkt-panel" ng-if="tickets.efsr_no != '' || tickets.mrf != '-'">
								<div class="col-lg-4 col-md-4 col-sm-4" ng-if="tickets.mrf != '-'">
                                    <h6>MRS Status</h6>
                                    <span class="fnt-size-11">{{tickets.mrf != '-' ? tickets.mrf : 'NA'}}</span>
                                </div>
                                <div class="col-lg-4 col-md-4 col-sm-4" ng-if="tickets.efsr_no != ''">
                                    <h6><span ng-if="tickets.fsrreport == 'e-FSR'">e-</span>FSR No. </h6>
                                    <span class="fnt-size-11" tooltip-placement="right" tooltip="{{tickets.efsr_date}}">{{tickets.efsr_no}}</span>
                                </div>
                                <div class="col-lg-4 col-md-4 col-sm-4" ng-if="tickets.efsr_no != ''">
                                    <h6><span ng-if="tickets.fsrreport == 'e-FSR'">e-</span>FSR </h6>
                                    <span class="fnt-size-11" ng-if="tickets.fsrreport == 'e-FSR'"><a href="{{base_url}}{{tickets.efsr_start ? 'mobile_app' : 'enersyscare_v2'}}/pdf/index.php?ticket_alias={{tickets.ticket_alias}}" target="_blank" tooltip-placement="top" tooltip="Click for e-FSR of {{tickets.ticket_id}}">{{tickets.fsrreport}}</a></span>
	                                <span class="fnt-size-11" ng-if="tickets.fsrreport == 'esca-FSR'"><a href="{{base_url}}images/esca_efsr/{{tickets.esca_efsr_link}}" target="_blank" tooltip-placement="top" tooltip="Click for e-FSR of {{tickets.ticket_id}}">FSR</a></span>
                                </div>
                            </div>
							<div class="row tkt-panel" ng-if="tickets.cust_file != ''">
								<div class="col-lg-4 col-md-4 col-sm-4">
									<h6>Other File</h6>
									<span class="fnt-size-11"><a href="{{base_url}}images/reports/{{tickets.cust_file}}" target="_blank" tooltip-placement="top" tooltip="Click for Other file of {{tickets.ticket_id}}">Click Here</a></span>
								</div>
							</div>
							<div class="mb20" ng-if="tickets.level_code > '2' && tickets.se_count!='0'">
								...
								<div class="row tkt-panel">
									<div class="col-lg-4 col-md-4 col-sm-4" ng-if="tickets.ser_obs != ''">
										<h6>Observation By Engineer</h6>
										<span class="fnt-size-11 wrd_break">{{tickets.ser_obs}}</span>
									</div>
									<div class="col-lg-4 col-md-4 col-sm-4" ng-if="tickets.action != ''">
										<h6>Action Taken By Engineer</h6>
										<span class="fnt-size-11 wrd_break">{{tickets.action}}</span>
									</div>
									<div class="col-lg-4 col-md-4 col-sm-4">
										<h6>Required Accessory</h6>
										<span class="fnt-size-11 wrd_break">{{tickets.req_acc}}</span>
									</div>
								</div>
							</div>
							<div class="mb20" ng-if="tickets.req.length != 0">
                                <h4 class="modal-title text-center">Required Items</h4>
                                <table class="table table-condensed" >
                                    <thead>
                                        <tr>
                            ...
                            <div class="mb20" ng-if="tickets.remark_length != 0">
                            ...
                            <div ng-if="tickets.planremark_length != 0">
                                <h4 class="modal-title text-center">Re Planned Remarks</h4>
								<table class="table table-condensed" >
									<thead>
										<tr>
											<th><a class="tktid">Sr.No</a></th>
											<th><a class="tktid">Service Engineer</a></th>
											<th><a class="tktid">Remark Date</a></th>
											<th><a class="tktid">Remark</a></th>
										</tr>
									</thead>
								</table>
								<table class="table table-hover table-bordered">
									<tbody>
										<tr class="tktBackground" ng-repeat="(keys,planrems) in tickets.planremark">
											<td>{{keys + 1}}</td>
											<td><p tooltip-placement="top" tooltip="{{planrems.employee_name}}">{{planrems.employee_name}}</p></td>
											<td class="hidden-xs hidden-sm">{{planrems.rem_date}}</td>
											<td>{{planrems.rem_alias}}</td>
										</tr>
									</tbody>
								</table>
							</div>
