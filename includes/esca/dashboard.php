...
<div class="page page-dashboard" ng-controller="DashboardEscaCtrl">
    <div class="row">
           <!-----Heading------>
    		<div class="col-md-12">
            ...
            <!-----Total no.of tickets------>
		<div class="col-lg-7 col-md-6 col-sm-12" ng-controller="esca_dash_view_form" ng-init="listSortingdb()">
			<form class="form-horizontal forms_esca" url="services/esca/ticket_status" name="userForm" method="post">
           ...
           <!-- Customer Satisfication Score-->
			...
			<div class="col-lg-5 col-md-6 col-sm-12" ng-controller="esca_customer_pulse_view" ng-init="listSortingdb()">
			<form class="form-horizontal forms_custesca" url="services/esca/customer_pulse" name="userForm" method="post">
				<div class="panel panel-default mb20 panel-hovered">
					...
					<div class="panel-body text-center">
						<c3-chart id="esca_c_pulse"></c3-chart>
					</div>
				</div>
			</form>
		</div>
			...
			<div class="col-lg-7 col-md-6 col-sm-12" ng-controller="escatodayinfoCtrl" ng-init="listSortingdb()">
			<form class="form-horizontal forms_esca_tdinfo" name="userForm" url="services/esca/today_info_report_block" method="post">
				<div class="panel panel-default mb20 panel-hovered analytics">
					...
					<div class="panel-body">
						<c3-chart id="esca_td_info"></c3-chart>
					</div>
				</div>
			</form>
		</div>
          	...
          	<!--TAT Status -->
            <div class="col-lg-5 col-md-6 col-sm-12" ng-controller="escatatconfigCtrl" ng-init="listSortingdb()">
			<form class="form-horizontal forms_esca_tat" name="userForm" url="services/esca/tat_status" method="post">
				<div class="panel panel-default mb20 panel-hovered">
					...
					<div class="panel-body text-center">
						<c3-chart id="esca_tat_con"></c3-chart>
					</div>
				</div>
			</form>
		</div>
			...
			<!-- Nature of Activity -->
		<div class="col-lg-7 col-md-6 col-sm-12" ng-controller="escaactivityconfigCtrl" ng-init="listSortingdb()">
			<form class="form-horizontal forms_esca_na" name="userForm" url="services/esca/nature_of_activity" method="post">
				<div class="panel panel-default mb20 panel-hovered">
					...
					<div class="panel-body text-center">
						<c3-chart id="esca_n_act"></c3-chart>
					</div>
				</div>
			</form>
		</div>
