...
<div class="modal-style">
	...
	<div class="modal-body" ng-controller="addingform">
		<form class="form-horizontal forms_add" data-went="#/employeemaster" method="post" url="services/esca/employeemaster_export" ng-submit="sendPost()" novalidate>
            <div class="row form-group" ng-controller="expzoneStateMulCntrl">
                    ...
                    <div class="col-sm-10 col-sm-offset-1 mb20" ng-controller="assetnamedropCntrl">
