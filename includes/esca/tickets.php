...
<div class="page page-ui-extras" ng-controller="ModalDemoCtrl">
	<div ng-controller="ticketescaCtrl as main">
    <div ng-controller="mul_view_form">
		<div class="panel panel-lined table-responsive panel-hovered mb10" style="" >
			...
			<ol class="breadcrumb breadcrumb-small right" style="margin-bottom:0px;">
				<li><a href="" ng-click="ticketescasexportOpen()" class="padding-10 export-btn">Export</a></li>
			</ol>
		</div>
		<div class="row">
			<div class="col-md-12 table-height">
				<div class="panel panel-lined table-responsive panel-hovered" style="overflow-x:hidden">
					<div class="panel panel-default">
						<form class="form-horizontal forms_ec" url="services/esca/ticket_mul_view" name="userForm" method="post" novalidate>
								...
								<thead>
									<tr>
                                        ...
                                        <th class="hidden-xs hidden-sm" ng-controller="activitylistCtrl">
                                            <select name="activityAlias" placeholder="Activity" class="SlectBox form-control" ng-model="activityAlias1" data-ng-change="listSorting()">
                                                <option value="" style="display:none" selected>Activity</option>
                                        ...
                                        <th class="hidden-xs hidden-sm" ng-controller="segmentdropCntrl">																								
                                            <select name="segmentAlias" placeholder="Segment" class="SlectBox form-control" ng-model="segmentAlias1" data-ng-change="listSorting()">
                                                <option value="" style="display:none" selected>Segment</option>
                                                <option ng-repeat="selectlist in firstDrop" value="{{selectlist.alias}}">{{selectlist.name}}</option>
                                                <option ng-if="firstDrop.length==0">No Records</option>
                                            </select>
                                        </th>
                                        ...
                                        <th ng-controller="leveldropCntrl">
                                            <select name="levels" placeholder="Levels" class="SlectBox form-control" ng-model="levels1" data-ng-change="listSorting()">
                                                <option value="" style="display:none" selected>Levels</option>
                                                <option ng-repeat="selectlist in firstDrop" value="{{selectlist.alias}}">{{selectlist.name}}</option>
                                        ...
                                        <th width="80px" class="hidden-xs hidden-sm" ng-controller="tatDropCntrl">
                                            <select name="tat" placeholder="TAT Level" class="SlectBox form-control" ng-model="tat1" data-ng-change="listSorting()">
                                                <option value="" style="display:none" selected>TAT</option>
                                        ...
                                        <th class="hidden-xs hidden-sm">
                                            ...
                                            <input type="text" class="droptxt1 hidden form-control" name="visits" ng-model="visits1" placeholder="Type keyword" data-ng-keyup="listSorting()"  />
                                            <span class="ion ion-ios-close-outline inptClose hidden" data-ng-click="listSorting()"></span>
                                        </th>
                                        <th class="hidden-xs hidden-sm">
								...
								<table class="table table-condensed table-hover">
									<tbody>
                                        <tr class="tktBackground" ng-repeat="data in datas.ticketDetails" >
                                            <td width="140px" ng-click="createing(data.ticket_alias)" class="tktClick"><span tooltip-placement="top" tooltip="Click to know details of {{data.ticket_id}}">{{data.ticket_id}}</span></td>
