              ...
              <div class="row form-group">  
                 ...
                 <div class="col-sm-4"  ng-controller="DatepickerDemoCtrl">
                	<md-input-container flex="" class="md-default-theme">
                        ...
                        <input type="text" ng-model="stratdate" class="form-control datepicker border-bottom " placeholder="Select date.." datepicker-popup="{{format}}" ng-click="open($event)" ng-model="dt" is-open="opened" min-date="minDate" max-date="'2025-06-22'" datepicker-options="dateOptions" date-disabled="disabled(date, mode)"  show-button-bar="false"/>                                              
                    </md-input-container>
				 </div>
                 ...
                 <div class="col-sm-4"  ng-controller="DatepickerDemoCtrl">
                	<md-input-container flex="" class="md-default-theme">
                        ...
                        <input type="text" ng-model="enddate" class="form-control datepicker border-bottom " placeholder="Select date.." datepicker-popup="{{format}}" ng-click="open($event)" ng-model="dt" is-open="opened" min-date="minDate" max-date="'2025-06-22'" datepicker-options="dateOptions" date-disabled="disabled(date, mode)"  show-button-bar="false"/>                                              
                    </md-input-container>
				 </div>
               </div>
               <div class="row form-group">  
                                ...
                                <tbody>
                                    <tr class="tbform">
                                    	<td ng-controller="DatepickerDemoCtrl">                    
                                            <input type="text" ng-model="stratdate" class="form-control datepicker border-bottom " placeholder="DD-MM-YYYY" datepicker-popup="{{format}}" ng-click="open($event)" ng-model="dt" is-open="opened" min-date="minDate" max-date="'2025-06-22'" datepicker-options="dateOptions" date-disabled="disabled(date, mode)"  show-button-bar="false"/>                                              
										</td>
                            ...
                            <table class="table table-condensed">
                                <tbody>
                                    <tr class="tbform">
                                        ...
                                        <td ng-controller="DatepickerDemoCtrl">                    
                                            <input type="text" ng-model="enddate" class="form-control datepicker border-bottom " placeholder="DD-MM-YYYY" datepicker-popup="{{format}}" ng-click="open($event)" ng-model="dt" is-open="opened" min-date="minDate" max-date="'2025-06-22'" datepicker-options="dateOptions" date-disabled="disabled(date, mode)"  show-button-bar="false"/>                                              
										</td>
                            ...
                            <table class="table table-condensed">
                                <tbody>
                                    <tr class="tbform">
                                        ...
                                        <td><input type="text" class="form-control" name="amount" placeholder="Amount"></td>
                                    	<td ng-controller="DatepickerDemoCtrl">                    
                                            <input type="text" ng-model="date" class="form-control datepicker border-bottom " placeholder="DD-MM-YYYY" datepicker-popup="{{format}}" ng-click="open($event)" ng-model="dt" is-open="opened" min-date="minDate" max-date="'2025-06-22'" datepicker-options="dateOptions" date-disabled="disabled(date, mode)"  show-button-bar="false"/>                                              
										</td>
                                        <td><input type="hidden" class="form-control" name="motbill[]" value="0"><input type="file" class="form-control" name="motbill[]"></td>
                                    </tr>
                               </tbody>
