 <style>
 .export-btn:hover{background-color:#428bca; color:#fff; border-radius:3px;}
 </style>
<div class="page page-ui-buttons" ng-controller="ModalDemoCtrl">
        ...
        <div class="row">
            ...
            <div class="col-md-12 table-height">
                <div class="panel panel-lined table-responsive panel-hovered" ng-controller="ExpensesCtrl">
                    ...
                    <table class="table table-condensed" >
                        ...
                        <tr>
                            <th>
                                ...
                                <input type="text" class="droptxt1 hidden" style="display:block; border:none; color:#000;" placeholder="Type keyword" ng-model="searchKeywords.billnumber" data-ng-keyup="search()">
                            ...
                            <th ng-controller="DatepickerDemoCtrl">
                             ...
                             <th>
                                <a class="tktid">Total Tour Expenses&nbsp;<span class="arrow caret"></span></a>
                                <input type="text" class="droptxt1 hidden" style="display:block; border:none; color:#000;" placeholder="Type keyword" ng-model="searchKeywords.totaltourexpenses" data-ng-keyup="search()">
                                <span class="ion ion-ios-close-outline inptClose hidden" data-ng-click="search()"></span>
                            </th>
                             <th>
                                <a class="tktid">Outstanding Balance&nbsp;<span class="arrow caret"></span></a>
                                <input type="text" class="droptxt1 hidden" style="display:block; border:none; color:#000;" placeholder="Type keyword" ng-model="searchKeywords.outstandingbalance" data-ng-keyup="search()">
                                <span class="ion ion-ios-close-outline inptClose hidden" data-ng-click="search()"></span>
                            </th>
                            <th>
                                <a class="tktid">Places Of Visit&nbsp;<span class="arrow caret"></span></a>
                                <input type="text" class="droptxt1 hidden" style="display:block; border:none; color:#000;" placeholder="Type keyword" ng-model="searchKeywords.placesofvisit" data-ng-keyup="search()">
                                <span class="ion ion-ios-close-outline inptClose hidden" data-ng-click="search()"></span>
                            </th>
                             <th>
                                <select multiple="multiple" placeholder="Approval Level" onchange="console.log($(this).children(':selected').length)" class="testSelAll2 form-control">
                                    <option value="DRAFTS">DRAFTS</option>
                                    <option value="HOD PENDING">HOD PENDING</option>
                                    <option value="SCMT PENDING">SCMT PENDING</option>
                        ...
                        <table class="table table-condensed">
                            <tbody>
                                <tr class="tktBackground" ng-repeat="data in currentPageStores track by $index | filter : searchKeywords">
                                    <td ng-click="materialinwardview(data.mrfnumber)">{{data.billnumber}}</td>
                                    <td>{{data.requesteddate}}</td>
                                    <td>{{data.totaltourexpenses}}</td>
                                    <td>{{data.outstandingbalance}}</td>
                                    <td>{{data.placesofvisit}}</td>
                                    <td>{{data.approvallevel}}</td>
                                </tr>
                           </tbody>
    ...
    <div><button type="button" class="btn btn-info ion ion-plus compose-btn" tooltip="Addnew" tooltip-placement="top" ng-click="submitexpenseOpen()" md-ink-ripple></button></div>         
</div>
<script>
