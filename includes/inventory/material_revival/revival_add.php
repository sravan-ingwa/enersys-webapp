...
.SumoSelect>.optWrapper.open {top: 15px!important}
...
<div class="modal-style" ng-controller="totalCellDropCtrl">	<!-- wrapper for specific style -->
	<div class="modal-header clearfix">
		<h4 class="modal-title">Create Revival</h4>
	...
	<div class="modal-body" ng-controller="addingform">
		...
		<form class="form-horizontal forms_add" name="userForm" role="form" data-went="#/Revival" enctype="multipart/form-data" method="post" url="services/inventory/material_revival_add" ng-submit="sendPost()" novalidate>
                ...
                <div class="row form-group mt20">
                    <div class="col-sm-4 {{secondDrop.length=='0' ? 'col-sm-offset-4':''}}">
					 <label class="selectlabel">Ware House</label>
                        <select name="wh_alias" class="form-control testSelAll2 selectdrop" placeholder="Ware House" ng-model="wh_alias" data-ng-change="wh_revival(wh_alias)">
				...
				<h3 ng-if="secondDrop.length=='0' && userForm.wh_alias.$dirty" class="text-center panel-body">No Cells for Revival</h3>
                        ...
                        <table class="table table-bordered table-striped" style="width:1500px;">
                            <tbody>
                                <tr ng-style="(clr[key] || clr1[key] || clr2[key] || clr3[key] || clr4[key] || clr5[key] || clr6[key] || clr7[key] || clr8[key] || clr9[key] || clr10[key] || clr11[key] || clr12[key] || clr13[key] || result[key]) && {'background-color':'#CCC'} || {'background-color': '#FFF'}" ng-modal="cells" ng-repeat="(key, cell) in secondDrop">
                                    ...
                                    <input type="text" class="upper form-control" readonly="readonly" placeholder="Cell Sr. No." valid-input value="{{cell.name}}"></td>
                                    <td><input type="text" ng-model="clr1[key]" class="form-control clr_{{key}}" ng-attr-name="{{result[key]!='' ? 'mf_date[]' : ''}}" mask="19/99" ng-model="mf_date[key]" restrict="reject" clean="true" placeholder="Mfd. Date"></td>
                                    <td><input type="text" ng-model="clr2[key]" class="form-control clr_{{key}}" ng-attr-name="{{result[key]!='' ? 'ocv[]' : ''}}" mask="9.99" ng-model="ocv[key]" restrict="reject" clean="true" placeholder="OCV"></td>
                                    <td><input type="text" ng-model="clr3[key]" class="form-control clr_{{key}}" ng-attr-name="{{result[key]!='' ? 'dis_current[]' : ''}}" placeholder="Dis. Current "></td>
                                    <td><input type="text" ng-model="clr4[key]" class="form-control clr_{{key}}" ng-attr-name="{{result[key]!='' ? 'a[]' : ''}}" mask="9.99" ng-model="th1[key]" restrict="reject" clean="true" placeholder="1st"></td>
                                    <td><input type="text" ng-model="clr5[key]" class="form-control clr_{{key}}" ng-attr-name="{{result[key]!='' ? 'b[]' : ''}}" mask="9.99" ng-model="th2[key]" restrict="reject" clean="true" placeholder="2nd"></td>
                                    <td><input type="text" ng-model="clr6[key]" class="form-control clr_{{key}}" ng-attr-name="{{result[key]!='' ? 'c[]' : ''}}" mask="9.99" ng-model="th3[key]" restrict="reject" clean="true" placeholder="3rd"></td>
                                    <td><input type="text" ng-model="clr7[key]" class="form-control clr_{{key}}" ng-attr-name="{{result[key]!='' ? 'd[]' : ''}}" mask="9.99" ng-model="th4[key]" restrict="reject" clean="true" placeholder="4th"></td>
                                    <td><input type="text" ng-model="clr8[key]" class="form-control clr_{{key}}" ng-attr-name="{{result[key]!='' ? 'e[]' : ''}}" mask="9.99" ng-model="th5[key]" restrict="reject" clean="true" placeholder="5th"></td>
                                    <td><input type="text" ng-model="clr9[key]" class="form-control clr_{{key}}" ng-attr-name="{{result[key]!='' ? 'f[]' : ''}}" mask="9.99" ng-model="th6[key]" restrict="reject" clean="true" placeholder="6th"></td>
                                    <td><input type="text" ng-model="clr10[key]" class="form-control clr_{{key}}" ng-attr-name="{{result[key]!='' ? 'g[]' : ''}}" mask="9.99" ng-model="th7[key]" restrict="reject" clean="true" placeholder="7th"></td>
                                    <td><input type="text" ng-model="clr11[key]" class="form-control clr_{{key}}" ng-attr-name="{{result[key]!='' ? 'h[]' : ''}}" mask="9.99" ng-model="th8[key]" restrict="reject" clean="true" placeholder="8th"></td>
                                    <td><input type="text" ng-model="clr12[key]" class="form-control clr_{{key}}" ng-attr-name="{{result[key]!='' ? 'i[]' : ''}}" mask="9.99" ng-model="th9[key]" restrict="reject" clean="true" placeholder="9th"></td>
                                    <td><input type="text" ng-model="clr13[key]" class="form-control clr_{{key}}" ng-attr-name="{{result[key]!='' ? 'j[]' : ''}}" mask="9.99" ng-model="th10[key]" restrict="reject" clean="true" placeholder="10th"></td>
                                    <td width="9%">
                                    	<select class="form-control clr_{{key}}" ng-attr-name="{{result[key]!='' ? 'result[]' : ''}}" ng-model="result[key]" placeholder="Result">
