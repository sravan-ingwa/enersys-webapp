...
<div class="page page-ui-extras" ng-controller="ModalDemoCtrl">
	<div ng-controller="inwardbalanceCtrl">
		...
		<div class="panel panel-lined table-responsive panel-hovered mb10">
			<ol class="breadcrumb breadcrumb-small left" style="margin-bottom:0px;">
				...
				<li><a href="" class="padding-10">Inward Balance</a></li>
			</ol>
			<ol class="breadcrumb breadcrumb-small right" style="margin-bottom:0px;" ng-if="datas.export">
				<li><a href="" ng-click="materialinwardbalexportOpen()" class="padding-10 export-btn" md-ink-ripple>Export</a></li>
			</ol>
		</div>
		<div class="row">
			<form class="form-horizontal forms_ec" url="services/inventory/inward_balance_multi" name="userForm" method="post" novalidate>
				<div class="col-xs-12">
				...
				<div class="col-sm-12" ng-if="datas.inwardcount=='1'">
					<div class="panel panel-default panel-hovered panel-stacked mb20">
						<div class="panel-heading"><span>Inward Balance Overview</span></div>
						...
						<div class="panel-footer clearfix" ng-if="datas.inwardcount=='1'">
						<div class="col-md-4">
				...
				<div class="col-sm-12 table-height" ng-if="datas.inwardcount=='0'"> <img src="images/nostock.png" class="norecords"/> </div>
			</form>
		</div>
		</div>
	</div>
