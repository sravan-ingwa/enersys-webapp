...
<div class="modal-style">	<!-- wrapper for specific style -->
	<div class="modal-header clearfix">
		<h4 class="modal-title">Export Material Balance</h4>
	...
	<div class="modal-body" ng-controller="addingform">
		...
		<form class="form-horizontal forms_add" name="materialbalanceexportForm" data-went="#/Materialbalance" method="post" url="services/inventory/material_balance_export" ng-submit="sendPost()" novalidate>
            <div class="row form-group">
                ...
                <div class="col-sm-10 col-sm-offset-1">
					<label class="selectlabel">Select Data Type&nbsp;<span style="color:#F00">*<span></label>
                    <select class="form-control testSelAll3 selectdrop" name="data_type[]" ng-model="data_type" multiple="multiple">
