...
<div class="modal-style">	<!-- wrapper for specific style -->
	<div class="modal-header clearfix">
		<h4 class="modal-title">Export Material Outward Balance</h4>
	...
	<div class="modal-body" ng-controller="addingform">
		...
		<form class="form-horizontal forms_add" name="materialbalanceexportForm" data-went="#/Materialoutward" method="post" url="services/inventory/material_outward_balance_export" ng-submit="sendPost()" novalidate>
