...
<div class="modal-style" ng-controller="refreshingEditCntl">	<!-- wrapper for specific style -->
	<div class="modal-header clearfix">
		<h4 class="modal-title">Edit Refreshing</h4>
	...
	<div class="modal-body" ng-controller="addingform">
		...
		<form class="form-horizontal forms_add" name="userForm" role="form" data-went="#/Refreshing" enctype="multipart/form-data" method="post" url="services/inventory/material_refreshing_update" ng-submit="sendPost()" novalidate>
                            ...
                            <tbody>
                                <tr ng-modal="cells" ng-repeat="(key, cell) in singleViews.type">
                                    ...
                                    <td width="9%">
										...
										<input type="text" class="upper form-control" value="{{cell.cell_sr_no}}" ng-disabled="cell.disable" ng-readonly="!cell.disable" placeholder="Cell Sr. No.">
									</td>
