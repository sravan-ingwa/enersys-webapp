...
table thead tr th {height:42px;}
  ...
  <div class="page page-ui-extras" ng-controller="ModalDemoCtrl">
	<div ng-controller="refreshingCtrl">
   ...
   <div class="panel panel-lined table-responsive panel-hovered mb10" style="" >
        <ol class="breadcrumb breadcrumb-small left" style="margin-bottom:0px;">
            ...
            <li><a href="" class="padding-10">Refreshing</a></li>
        </ol>
        <ol class="breadcrumb breadcrumb-small right" style="margin-bottom:0px;" ng-if="datas.export">
			<li><a href="" ng-click="refreshingexport()" class="padding-10 export-btn">Export</a></li>
        </ol>
   </div>
		<!-- row -->
		<div class="row">
			...
			<div class="col-md-12 table-height">
				...
				<form class="form-horizontal forms_ec" url="services/inventory/material_refreshing_mul_view" name="userForm" method="post" novalidate>
                    <table class="table table-condensed" >
                        <thead>
                        <tr>
                            <th>
                                <a class="tktid">Refreshing No.&nbsp;<span class="arrow caret"></span></a>
                                <input type="text" class="droptxt1 hidden" style="display:block; border:none; color:#000;" name="refreshing_no" placeholder="Refreshing No." ng-model="searchKeywords.refreshing_no" data-ng-keyup="listSorting()">
                        ...
                        <table class="table table-condensed">
                            <tbody>
                                <tr class="tktBackground" ng-repeat="data in datas.requestDetails">
                                    <td ng-click="refreshing_view(data.refreshing_alias)">{{data.refreshing_no}}</td>
                            ...
                            <a href="" class="ml3" tooltip="Advance Edit" tooltip-placement="bottom" ng-click="setAlias(data.refreshing_alias);refreshingadveditOpen();" ng-if="datas.advedit">
                                <span class="fa fa-spl-edit"></span>
                            </a>
                            <a href="javascript:void(0)" class="ml3" tooltip="Delete Refreshing" tooltip-placement="bottom" ng-click="refreshingdelOpen(data);" ng-if="datas.delete">
		...
		<div ng-if="datas.add"><button type="button" class="btn btn-info ion ion-plus compose-btn" tooltip="Addnew" tooltip-placement="top" ng-click="refreshingaddOpen()" md-ink-ripple></button></div>
	</div> 
	</div>
<div id="ticketviesw">
<div class="site-settings ticketviesw clearfix  col-xs-8 col-lg-8 floating-sidebar" ng-class="{'open': refreshing_open}">
        <div class="sidebar-wrap text-uppercase mt46">
                <div class="group clearfix head tkt-heading2">
                    <div class="left">
                    <span class="ion ion-close-round mr10 tktviewClose" ng-click="removerefreshing()"></span>
                        <span><strong>View Refreshing</strong></span>
                    </div>
                    <div class="right">
                        <div class="btn-group btn-group-sm" ng-controller="ModalDemoCtrl">
                            <a ng-if="singleViews.adv_edit" href="" class="ml10" tooltip="Advance Edit" tooltip-placement="bottom" ng-click="refreshingadveditOpen()"><span class="fa fa-wrench"></span></a>
                            <!--<a href="" ng-if="" class="ml10" tooltip="Edit" tooltip-placement="bottom" ng-click="refreshingeditOpen()"><span class="fa fa-edit"></span></a>-->
                            <a href="services/inventory/refreshing_print.php?alias={{singleViews.refreshing_alias}}" target="_blank" tooltip="Print" class="ml10" tooltip-placement="bottom"><span class="ion ion-android-print"></span></a>
                            <a href="services/inventory/refreshing_download.php?alias={{singleViews.refreshing_alias}}" target="_blank" tooltip="Download" class="ml10" tooltip-placement="bottom"><span class="ion ion-android-download"></span></a>
                        </div>
                    </div>
                </div>
            	<div class="panel-body clearfix freez-panel">
                    <div class="row tkt-panel">
                        <div class="col-lg-4 col-md-4 col-sm-4">
                          <h6>Refreshing No</h6>
                          <span class="fnt-size-11">{{singleViews.refreshing_no}}</span>
                        </div>
                        <div class="col-lg-4 col-md-4 col-sm-4">
                          <h6>Ware House</h6>
