...
<div class="modal-style" ng-controller="refreshingEditCntl">	<!-- wrapper for specific style -->
	<div class="modal-header clearfix">
		<h4 class="modal-title">Advance Edit Refreshing</h4>
	...
	<div class="modal-body" ng-controller="addingform">
		...
		<form class="form-horizontal forms_add" name="userForm" role="form" data-went="#/Refreshing" enctype="multipart/form-data" method="post" url="services/inventory/material_refreshing_adv_edit" ng-submit="sendPost()" novalidate>
				<input type="hidden" name="refreshing_alias" value="{{singleViews.refreshing_alias}}" />
                ...
                <div class="row form-group mt20">
                    <div class="col-sm-4">
                        <md-input-container flex="" class="md-default-theme">
                            <label for="input_00D">Refreshing No</label>
                            <input type="text" ng-model="singleViews.refreshing_no" class="ng-pristine ng-valid md-input ng-touched" value="{{singleViews.refreshing_no}}" tabindex="0" aria-invalid="false" ng-readonly="true">
                        </md-input-container>
                    </div>
                    <div class="col-sm-4">
                        <md-input-container flex="" class="md-default-theme">
