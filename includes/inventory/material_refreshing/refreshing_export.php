...
<div class="modal-style" ng-controller="fromToDateCtrl">	<!-- wrapper for specific style -->
	<div class="modal-header clearfix">
		<h4 class="modal-title">Export Refreshing</h4>
		<span class="close ion ion-android-close" ng-click="modalClose()"></span>
	</div>
	<div class="modal-body" ng-controller="addingform">
		<form class="form-horizontal forms_add" name="refreshexportForm" data-went="#/Refreshing" method="post" url="services/inventory/material_refreshing_export" ng-submit="sendPost()" novalidate>
