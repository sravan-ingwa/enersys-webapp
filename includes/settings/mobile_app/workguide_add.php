...
<div class="modal-style">
	<div class="modal-header clearfix">
		<h4 class="modal-title">Create Work Guide</h4>
	...
	<div class="modal-body" ng-controller="addingform">
        ...
        <form class="form-horizontal forms_add" name="workguideForm" data-went="#/settings/mobile_app/workguide_view" method="post" url="services/settings/workguide_add" ng-submit="sendPost()" novalidate>
                <div class="row form-group newmd">
                    <div class="col-sm-12">
                        <md-input-container class="md-default-theme">
                            <label for="input_00D">Workguide Title</label>
                            <input ng-model="workguide" name="workguide_name" class="ng-pristine ng-valid md-input ng-touched">
                        </md-input-container>
                         <span class="help-block" ng-show="workguideForm.workguide_name.$dirty && workguideForm.workguide_name.$invalid">
                            <span ng-show="workguideForm.workguide_name.$error.required">workguide is Required</span>
                        </span>
                    </div>
									...
									<div class="form-group" ng-repeat="type in field.itemtype">
										<div class="col-sm-12">
											<md-input-container flex="" class="md-default-theme md-input-has-value">
												<label for="input_00D">Workguide List</label>
