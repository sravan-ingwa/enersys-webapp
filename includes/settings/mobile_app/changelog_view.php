...
<div ng-controller="changelogCntl">
	<div class="panel panel-lined table-responsive panel-hovered mb10" style="">
		<ol class="breadcrumb breadcrumb-small left" style="margin-bottom:0px;">
			...
			<li><a href="" class="padding-10">Change Log</a></li>
		</ol>
	...
	<div class="row">
		<div class="col-md-12 table-height" ng-controller="mul_view_form">
		 <form class="form-horizontal forms_ec" url="services/settings/changelog_mul_view" name="userForm" method="post" novalidate>
			<table class="table table-condensed">
				<thead>
					<tr>
						<th>
							<a class="tktid">ChangeLog<span class="arrow caret"></span></a>
							<input type="text" class="droptxt1 hidden" name="change_log" style="display:block; border:none; color:#000;" placeholder="Type keyword" data-ng-keyup="listSorting()" />
			...
			<div>
				<accordion class="accordion-panel accord-data" ng-repeat="data in datas.changelogDetails">
					<accordion-group is-open="lc_status.open" ng-class="{'panel-info': lc_status.open}">
						<accordion-heading>
							<span>{{data.changelog_Name}} &nbsp; </span><i class="mt2 ion small" style="color:#000" ng-class="{'ion-chevron-down': lc_status.open, 'ion-chevron-right': !lc_status.open}" style="color:#000"></i>
							<div class="right">
								<div class="btn-group btn-group-sm">
									<a href="" ng-click="changelogeditOpen(data.changelog_alias);" class="ml10" tooltip="Edit" tooltip tooltip-placement="bottom" ng-if="datas.edit"><span class="fa fa-edit"></span></a>
									<a ng-click="changelog_print(data.changelog_alias);" target="_blank" tooltip="Print" class="ml10" tooltip-placement="bottom"><span class="fa fa-print"></span></a>
									<a ng-click="changelog_download(data.changelog_alias);" target="_blank" tooltip="Download" class="ml10" tooltip-placement="bottom"><span class="fa fa-download"></span></a>
									<a ng-click="settingsDeleteOpen('changelog', data)" target="_blank" tooltip="Delete" class="ml10" tooltip-placement="bottom" ng-if="datas.delete"><span class="fa fa-delete-white"></span></a>
								</div>
							</div>
						</accordion-heading>
						<ul class="accord-showcontent" ng-repeat="dat in data.sub_changelog_Name">
							<li>{{dat.name}}</li>
						</ul>
					</accordion-group>
				</accordion>
	...
	<div><button type="button" class="btn btn-info ion ion-plus compose-btn" tooltip="Addnew" tooltip-placement="top" ng-if="add" ng-click="changelogaddOpen()" md-ink-ripple></button></div> 
</div>
</div>
<script>
