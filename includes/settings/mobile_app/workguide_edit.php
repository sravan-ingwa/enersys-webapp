...
<div>
<div class="modal-style" ng-controller="workguideEditCntl">	<!-- wrapper for specific style -->
	<div class="modal-header clearfix">
		<h4 class="modal-title">Edit Work guide{{singleViews.mainguide_alias}}</h4>
		<span class="close ion ion-android-close" ng-click="modalClose()"></span>
	</div>
	<div class="modal-body" ng-controller="addingform">
		<div>
        <form class="form-horizontal forms_add Editworkguide" name="workguideForm" data-went="#/settings/mobile_app/workguide_view" method="post" url="services/settings/workguide_update" ng-submit="sendPost()" novalidate>
						...
						<div class="panel-body">
							<div class="row form-group" ng-repeat="field in forms">
								 <md-input-container class="md-default-theme">
									<label for="input_00D">Work Guide Title</label>
								...
								<div>
									<div class="form-group" ng-init="field.itemtype=singleViews.sub_work_guide">
										<div class="col-sm-12 newinput" ng-repeat="(key,type) in field.itemtype">
											<input type="hidden" ng-model="type.sub_alias" value="{{type.sub_alias}}" name="sub_alias[]" />
											<md-input-container flex="" class="md-default-theme md-input-has-value">
												<label for="input_00D">Sub work guide {{key+1}}</label>
