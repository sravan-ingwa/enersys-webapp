...
<div ng-controller="LimitsCtrl">
   <div class="panel panel-lined table-responsive panel-hovered mb10">
        <ol class="breadcrumb breadcrumb-small left" style="margin-bottom:0px;">
            ...
            <li><a href="" class="padding-10">Limits</a></li>
        </ol>
        <ol class="breadcrumb breadcrumb-small right" style="margin-bottom:0px;">
            <li><a href="exports/{{expenseViews.file_name}}.xlsx" ng-click="limitexport()" class="padding-10 export-btn" ng-if="expenses.export">Export</a></li>
        </ol>
   </div>
		<!-- row -->
		<div class="row">
			...
			<div class="col-md-12 table-height">
				<div class="panel panel-lined table-responsive panel-hovered">
            	 ...
            	 <form class="form-horizontal forms_exp" url="services/expense_tracker/limit_mul_view" name="userForm" method="post" novalidate>
                    <table class="table table-condensed" >
                        <thead>
                        <tr class="tabHeight">
                            <th>
                                <a class="tktid">Designation&nbsp;<span class="arrow caret"></span></a>
                                <input type="text" class="droptxt1 hidden" name="designation_alias" style="display:block; border:none; color:#000;" placeholder="Type keyword" data-ng-keyup="expsorting()">
                            ...
                            <th>
                                ...
                                <input type="text" class="droptxt1 hidden" name="limit_amount" style="display:block; border:none; color:#000;" placeholder="Type keyword" data-ng-keyup="expsorting()">
                                <span class="ion ion-ios-close-outline inptClose hidden" data-ng-click="expsorting()"></span>
                            </th>
                    ...
                    <div class="div-table-content">
                        <table class="table table-condensed table-hover">
                           <tbody>
                           		<tr class="tktBackground" ng-repeat="exp in expenses.limitDetails">
                                    <td ng-click="limits(exp.limit_alias)"><span tooltip-placement="top" tooltip="Click to know details of {{exp.designation_alias}}">{{exp.designation_alias}}</span></td>
                                    <td>{{exp.limit_amount}}</td>
                                    <td class="hidden-xs hidden-sm" ng-if="expenses.edit || expenses.delete">
                                        <a href="" class="ml3" tooltip="Advance Edit" tooltip-placement="bottom" ng-click="setAlias(exp.limit_alias);limitsEditOpen();" ng-if="expenses.edit">
                                            <span class="fa fa-spl-edit"></span>
                                        </a>
                                        <a href="javascript:void(0)" class="ml3" tooltip="Delete" tooltip-placement="bottom" 
                                        ng-click="settingsDeleteOpen('limits', exp);" ng-if="expenses.delete">
                                            <span class="fa fa-delete"></span>
                                        </a>
                                    </td>
                                </tr>
                           </tbody>
                            <tfoot ng-if="expenses.limitDetails.length=='0'"><tr><td>No Records</td></tr></tfoot>
                        </table>
                    </div>
                    <!-- #end data table -->	
                     <div class="panel-footer clearfix" ng-if="expenses.limitDetails.length!='0'">
                        <div class="col-md-4">
    ...
    <div><button type="button" class="btn btn-info ion ion-plus compose-btn" tooltip="Addnew" tooltip-placement="top" ng-click="limitsOpen()" ng-if="expenses.add" md-ink-ripple></button></div>
<div id="ticketviesw">
	<div class="site-settings ticketviesw clearfix  col-xs-6 floating-sidebar" ng-class="{'open': limits_open}" custom-scrollbar>
        <div class="sidebar-wrap text-uppercase">
                <div class="group clearfix head tkt-heading">
                    <div class="left">
                    <span class="ion ion-close-round mr10 tktviewClose" ng-click="removeLimits()"></span>
                        <span><strong>View Advance Limit</strong></span>
                    </div>
                    <div class="right">
                        <div class="btn-group btn-group-sm">
                            <a href="services/expense_tracker/limits_print.php?alias={{expenseViews.limit_alias}}" target="_blank" tooltip="Print" class="ml10" tooltip-placement="bottom"><span class="ion ion-android-print"></span></a>
                            <a href="services/expense_tracker/limits_download.php?alias={{expenseViews.limit_alias}}" target="_blank" tooltip="Download" class="ml10" tooltip-placement="bottom"><span class="ion ion-android-download"></span></a>
                        </div>
                    </div>
                </div>
            	<div class="panel-body">
                    <div class="row tkt-panel">
                        <div class="col-lg-4 col-md-4 col-sm-4">
                          <h6>Designation</h6>
                          <span class="fnt-size-11">{{expenseViews.designation_alias}}</span>
                        </div>
                        <div class="col-lg-4 col-md-4 col-sm-4">
                          <h6>Amount</h6>
                          <span class="fnt-size-11">{{expenseViews.limit_amount}}</span>
                        </div>
                    </div>
              	</div>
            </div>
