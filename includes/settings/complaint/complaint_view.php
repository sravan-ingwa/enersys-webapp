  <style>
  .SumoSelect > .CaptionCont > span {padding-right: 30px !important;}
  </style>
  <div class="page page-ui-extras" ng-controller="ModalDemoCtrl">
<div ng-controller="TicketcomplaintCtrl">
   <div class="panel panel-lined table-responsive panel-hovered mb10" style="" >
        <ol class="breadcrumb breadcrumb-small left" style="margin-bottom:0px;">
            ...
            <li><a href="" class="padding-10">Ticket Complaintes</a></li>
        </ol>
         <ol class="breadcrumb breadcrumb-small right" style="margin-bottom:0px;">
            <li><a href="exports/{{singleViews.file_name}}.xlsx" ng-click="tktcomplaintexport()" class="padding-10 export-btn" ng-if="export">Export</a></li>
        </ol>
   </div>
		<!-- row -->
		<div class="row">
			...
			<div class="col-md-12 table-height">
                ...
                <div class="panel panel-default" ng-controller="mul_view_form">
            	 <form class="form-horizontal forms_ec" url="services/settings/ticketcomplaint_mul_view" name="userForm" method="post" novalidate>
                    <table class="table table-condensed" >
                        <thead>
                        <tr>
                            <th ng-controller="activitydropCntrl">
                           ...
                           <th>
                                <a class="tktid">Nature Of Complaint<span class="arrow caret"></span></a>
                                <input type="text" class="droptxt1 hidden" name="complaintName" style="display:block; border:none; color:#000;" placeholder="Type keyword" data-ng-keyup="listSorting()">
                    ...
                    <div class="div-table-content">
                        <table class="table table-condensed table-hover">
                            <tbody>
                                <tr class="tktBackground" ng-repeat="data in datas.complaintDetails">
                                	<td ng-click="ticketcomplaintview(data.complaint_alias)"><span tooltip-placement="top" tooltip="Click to know details of {{data.activity_code}}">{{data.activity_name}}</span></td>
                                    <td>{{data.complaint_name}}</td>
                                    <td class="hidden-xs hidden-sm" ng-if="datas.edit || datas.delete">
                                        <a href="" class="ml3" tooltip="Advance Edit" tooltip-placement="bottom" ng-click="setSettingsAlias(data.complaint_alias);ticketcomplainteditOpen();" ng-if="datas.edit">
                                            <span class="fa fa-spl-edit"></span>
                                        </a>
                                        <a href="javascript:void(0)" class="ml3" tooltip="Delete" tooltip-placement="bottom" 
                                        ng-click="settingsDeleteOpen('complaints', data);" ng-if="datas.delete">
                                            <span class="fa fa-delete"></span>
                                        </a>
                                    </td>
                                </tr>
                            </tbody>
                            <tfoot ng-if="datas.complaintDetails.length=='0'"><tr><td>No Records</td></tr></tfoot>
                        </table>
                    </div>
                    <!-- #end data table -->	
                     <div class="panel-footer clearfix" ng-if="datas.complaintDetails.length!='0'">
                        <div class="col-md-4">
    ...
    <div><button type="button" class="btn btn-info ion ion-plus compose-btn" tooltip="Addnew" tooltip-placement="top" ng-click="ticketcomplOpen()" ng-if="add" md-ink-ripple></button></div>
<div id="ticketviesw">
	<div class="site-settings ticketviesw clearfix  col-xs-6 floating-sidebar" ng-class="{'open': ticketcomplaint_open}" custom-scrollbar>
        <div class="sidebar-wrap text-uppercase">
                <div class="group clearfix head tkt-heading">
                    <div class="left">
                    <span class="ion ion-close-round mr10 tktviewClose" ng-click="removepticketcomplaintView()"></span>
                        <span><strong>view nature of complaints</strong></span>
                    </div>
                    <div class="right" ng-controller="ModalDemoCtrl">
                        <div class="btn-group btn-group-sm">
                        	<a href="services/settings/ticket_complaint_print.php?alias={{singleViews.complaint_alias}}" tooltip="Print" class="ml10" tooltip-placement="bottom"><span class="ion ion-android-print"></span></a>
                   			<a href="services/settings/ticket_complaint_download.php?alias={{singleViews.complaint_alias}}" target="_blank" tooltip="Download" class="ml10" tooltip-placement="bottom"><span class="ion ion-android-download"></span></a>
                        </div>
                    </div>
                </div>
            	<div class="panel-body">
                    <div class="row tkt-panel">
                        <div class="col-lg-6 col-md-6 col-sm-6">
                          <h6>Nature Of Activity</h6>
                          <span class="fnt-size-11">{{singleViews.activity_name}}</span>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-6">
                          <h6>Nature Of Complaint</h6>
                          <span class="fnt-size-11">{{singleViews.complaint_name}}</span>
                        </div>
                    </div>
              	</div>
            </div>
