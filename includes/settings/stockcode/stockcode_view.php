...
<div ng-controller="StockcodeCtrl">
   <div class="panel panel-lined table-responsive panel-hovered mb10" style="" >
        <ol class="breadcrumb breadcrumb-small left" style="margin-bottom:0px;">
            ...
            <li><a href="" class="padding-10">Stock Code</a></li>
        </ol>
        <ol class="breadcrumb breadcrumb-small right" style="margin-bottom:0px;">
            <li><a href="exports/{{singleViews.file_name}}.xlsx" ng-click="stockcodeexport()" class="padding-10 export-btn" ng-if="export">Export</a></li>
        </ol>
   </div>
		<!-- row -->
		<div class="row">
			...
			<div class="col-md-12 table-height">
                ...
                <div class="panel panel-default" ng-controller="mul_view_form">
            	 <form class="form-horizontal forms_ec" url="services/settings/stockcode_mul_view" name="userForm" method="post" novalidate>
                    <table class="table table-condensed" >
                        <thead>
                        <tr>
                            <th ng-controller="stockcodeCtrl_cell">
                                <select name="stockAlias" placeholder="Stock Code" class="SlectBox form-control" ng-model="selectt.id" data-ng-change="listSorting()">
                                    <option value="" style="display:none">Stock Code</option>
                                    <option ng-repeat="stockcode in firstDrop" value="{{stockcode.alias}}">{{stockcode.name}}</option>
                                    <option ng-if="firstDrop.length==0">No Records</option>
                                </select>
                            </th>
                             <th>
                                <a class="tktid">Stock Description&nbsp;<span class="arrow caret"></span></a>
                    ...
                    <div class="div-table-content">
                        <table class="table table-condensed table-hover">
                            <tbody>
                                <tr class="tktBackground" ng-repeat="data in datas.stockcodeDetails">
                                    <td ng-click="stockcodeview(data.stock_alias)"><span tooltip-placement="top" tooltip="Click to know details of {{data.stock_code}}">{{data.stock_code}}</span></td>
                                    <td>{{data.description}}</td>
                                </tr>
                           </tbody>
                            <tfoot ng-if="datas.stockcodeDetails.length=='0'"><tr><td>No Records</td></tr></tfoot>
                        </table>
                    </div>
                    <!-- #end data table -->	
                     <div class="panel-footer clearfix" ng-if="datas.stockcodeDetails.length!='0'">
                        <div class="col-md-4">
    ...
    <!--<div><button type="button" class="btn btn-info ion ion-plus compose-btn" tooltip="Addnew" tooltip-placement="top" ng-click="stockOpen()" md-ink-ripple></button></div>-->


<div id="ticketviesw">
	<div class="site-settings ticketviesw clearfix  col-xs-6 floating-sidebar" ng-class="{'open': stockcode_open}" custom-scrollbar>
        <div class="sidebar-wrap text-uppercase">
                <div class="group clearfix head tkt-heading">
                    <div class="left">
                    <span class="ion ion-close-round mr10 tktviewClose" ng-click="removestockcodeView()"></span>
                        <span><strong>View stock code</strong></span>
                    </div>
                    <div class="right" ng-controller="ModalDemoCtrl">
                        <div class="btn-group btn-group-sm">
                            <a href="services/settings/stock_code_print.php?alias={{singleViews.stock_alias}}" tooltip="Print" class="ml10" tooltip-placement="bottom"><span class="ion ion-android-print"></span></a>
                            <a href="services/settings/stock_code_download.php?alias={{singleViews.stock_alias}}" tooltip="Download" class="ml10" tooltip-placement="bottom"><span class="ion ion-android-download"></span></a>
                        </div>
                    </div>
                </div>
            	<div class="panel-body">
                    <div class="row tkt-panel">
                        <div class="col-lg-6 col-md-6 col-sm-6">
                          <h6>Stock Code</h6>
                          <span class="fnt-size-11">{{singleViews.stock_code}}</span>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-6">
