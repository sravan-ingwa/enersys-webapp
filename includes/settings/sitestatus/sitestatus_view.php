...
<div ng-controller="SitestatusCtrl">
	<div class="panel panel-lined table-responsive panel-hovered mb10" style="">
		<ol class="breadcrumb breadcrumb-small left" style="margin-bottom:0px;">
			...
			<li><a href="" class="padding-10">Site Status</a></li>
		</ol>
	</div>
	<div class="row">
		<div class="col-md-12 table-height">
			<div class="panel panel-lined table-responsive panel-hovered">
				<div class="panel panel-default" ng-controller="mul_view_form">
            	 <form class="form-horizontal forms_ec" url="services/settings/sitestatus_mul_view" name="userForm" method="post" novalidate>
					<table class="table table-condensed">
						<thead>
							<tr>
                                <th>
                                    <a class="tktid">Site Status&nbsp;<span class="arrow caret"></span></a>
                                    <input type="text" class="droptxt1 hidden" style="display:block; border:none; color:#000;" name="siteStatus" placeholder="Type keyword" data-ng-keyup="listSorting()">
					...
					<div class="div-table-content">
						<table class="table table-condensed table-hover">
							<tbody>
								<tr class="tktBackground" ng-repeat="data in datas.sitestatusDetails">
									<td ng-click="sitestatusview(data.site_status_alias)"><span tooltip-placement="top" tooltip="Click to know details of {{data.site_status}}">{{data.site_status}}</span></td>
								</tr>
							</tbody>
							<tfoot ng-if="datas.sitestatusDetails.length=='0'"><tr><td>No Records</td></tr></tfoot>
						</table>
					</div>
					<div class="panel-footer clearfix" ng-if="datas.sitestatusDetails.length!='0'">
                        <div class="col-md-4">
	...
	<div><button type="button" class="btn btn-info ion ion-plus compose-btn" tooltip="Addnew" tooltip-placement="top"  ng-click="siteStatusaddOpen()" md-ink-ripple></button></div> 
<div class="site-settings ticketviesw clearfix  col-xs-6 col-lg-4 col-md-4 col-sm-4 floating-sidebar" ng-class="{'open': sitestatus_open}" custom-scrollbar>
	<div class="sidebar-wrap text-uppercase">
		<div class="group clearfix head tkt-heading">
			<div class="left">
				<span class="ion ion-close-round mr10 tktviewClose" ng-click="removesitestatusView()"></span>
				<span><strong>View Site status</strong></span>
			</div>
			<div class="right">
				<div class="btn-group btn-group-sm">
                    <a href="" ng-click="siteStatuseditOpen()" class="ml10" tooltip="Edit" tooltip tooltip-placement="bottom"><span class="fa fa-edit"></span></a>
                    <a href="" tooltip="Print" class="ml10" tooltip tooltip-placement="bottom"><span class="ion ion-android-print"></span></a>
                    <a href="" tooltip="Download" class="ml10" tooltip tooltip-placement="bottom"><span class="ion ion-android-download"></span></a>
				</div>
			</div>
		</div>
