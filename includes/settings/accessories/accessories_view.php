...
<div ng-controller="AccessoriesCtrl">
   <div class="panel panel-lined table-responsive panel-hovered mb10" style="" >
        <ol class="breadcrumb breadcrumb-small left" style="margin-bottom:0px;">
            ...
            <li><a href="" class="padding-10">Accessories</a></li>
        </ol>
         <ol class="breadcrumb breadcrumb-small right" style="margin-bottom:0px;">
            <li><a href="exports/{{singleViews.file_name}}.xlsx" ng-if="export" ng-click="accessexport()" class="padding-10 export-btn">Export</a></li>
        </ol>
   </div>
		<!-- row -->
		<div class="row">
			...
			<div class="col-md-12 table-height">
				<div class="panel panel-lined table-responsive panel-hovered">
            	 ...
            	 <form class="form-horizontal forms_ec" url="services/settings/accessories_mul_view" name="userForm" method="post" novalidate>
                    <table class="table table-condensed" >
                        ...
                        <tr>
                            ...
                            <th class="hidden-xs hidden-sm">
                                <a class="tktid">Accessory Desc&nbsp;<span class="arrow caret"></span></a>
                                <input type="text" class="droptxt1 hidden" name="itemDescription" style="display:block; border:none; color:#000;" placeholder="Type keyword" data-ng-keyup="listSorting()">
                                <span class="ion ion-ios-close-outline inptClose hidden" data-ng-click="listSorting()"></span>
                            </th>
							<th class="hidden-xs hidden-sm" ng-controller="measurementdropCntrl">																								
								<select name="measurement" placeholder="Measurement" class="SlectBox form-control" ng-model="measurement" data-ng-change="listSorting()">
									<option value="" style="display:none">Measurement</option>
									<option ng-repeat="measure in measurementdrop" value="{{measure.name}}">{{measure.name}}</option>
									<option ng-if="measurementdrop.length==0">No Records</option>
								</select>
							</th>
                            <!--<th class="hidden-xs hidden-sm">
                                <a class="tktid">Product Desc&nbsp;<span class="arrow caret"></span></a>
                                <input type="text" class="droptxt1 hidden" name="productAlias" style="display:block; border:none; color:#000;" placeholder="Type keyword" data-ng-keyup="listSorting()">
                                <span class="ion ion-ios-close-outline inptClose hidden" data-ng-click="listSorting()"></span>
                            </th>-->
                            <th>
                    ...
                    <div class="div-table-content">
                        <table class="table table-condensed table-hover">
                           <tbody>
                           		<tr class="tktBackground" ng-repeat="data in datas.accessoriesDetails">
                                    <td ng-click="accessoriesview(data.accessories_alias)"><span tooltip-placement="top" tooltip="Click to know details of {{data.customer_code}}">{{data.item_code}}</span></td>
                                    <td class="hidden-xs hidden-sm">{{data.accessory_description}}</td>
									<td class="hidden-xs hidden-sm">{{data.measurement}}</td>
                                    <td>{{data.price}}</td>
                                    <td>{{data.weight}}</td>
                                    <td class="hidden-xs hidden-sm" ng-if="datas.edit || datas.delete">
                                        <a href="" class="ml3" tooltip="Advance Edit" tooltip-placement="bottom" ng-click="setSettingsAlias(data.accessories_alias);accessorieseditOpen();" ng-if="datas.edit">
                                            <span class="fa fa-spl-edit"></span>
                                        </a>
                                        <a href="javascript:void(0)" class="ml3" tooltip="Delete" tooltip-placement="bottom" 
                                        ng-click="settingsDeleteOpen('accessories', data);" ng-if="datas.delete">
                                            <span class="fa fa-delete"></span>
                                        </a>
                                    </td>
                                </tr>
                           </tbody>
                            <tfoot ng-if="datas.accessoriesDetails.length=='0'"><tr><td>No Records</td></tr></tfoot>
                        </table>
                    </div>
                    <!-- #end data table -->	
						 <div class="panel-footer clearfix" ng-if="datas.accessoriesDetails.length!='0'">
							<div class="col-md-4">
    ...
    <div><button type="button" class="btn btn-info ion ion-plus compose-btn" tooltip="Addnew" tooltip-placement="top" ng-if="add" ng-click="accessoriesaddOpen()" md-ink-ripple></button></div>


<div id="ticketviesw">
	<div class="site-settings ticketviesw clearfix  col-xs-6 floating-sidebar" ng-class="{'open': accessories_open}" custom-scrollbar>
        <div class="sidebar-wrap text-uppercase">
                <div class="group clearfix head tkt-heading">
                    <div class="left">
                    <span class="ion ion-close-round mr10 tktviewClose" ng-click="removeaccessoriesView()"></span>
                        <span><strong>view Accessories</strong></span>
                    </div>
                    <div class="right" ng-controller="ModalDemoCtrl">
                        <div class="btn-group btn-group-sm">
                            <a href="services/settings/accessories_print.php?alias={{singleViews.accessories_alias}}" tooltip="Print" class="ml10" tooltip-placement="bottom"><span class="ion ion-android-print"></span></a>
                    		<a href="services/settings/accessories_download.php?alias={{singleViews.accessories_alias}}" tooltip="Download" class="ml10" tooltip-placement="bottom"><span class="ion ion-android-download"></span></a>
                        </div>
                    </div>
                </div>
            	<div class="panel-body">
                    <div class="row tkt-panel">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4">
                          ...
                          <span class="fnt-size-11">{{singleViews.accessory_description}}</span>
                        </div>
                        <div class="col-lg-4 col-md-4 col-sm-4">
                          <h6>Measurement</h6>
                          <span class="fnt-size-11">{{singleViews.measurement}}</span>
                        </div>
                        <!--<div class="col-lg-4 col-md-4 col-sm-4">
