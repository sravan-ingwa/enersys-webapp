...
<div ng-controller="SegmentCtrl">
   <div class="panel panel-lined table-responsive panel-hovered mb10" style="" >
        <ol class="breadcrumb breadcrumb-small left" style="margin-bottom:0px;">
            ...
            <li><a href="" class="padding-10">Segment</a></li>
        </ol>
        <ol class="breadcrumb breadcrumb-small right" style="margin-bottom:0px;">
            <li><a href="exports/{{singleViews.file_name}}.xlsx" ng-click="segmentexport()" class="padding-10 export-btn" ng-if="export">Export</a></li>
        </ol>
   </div>
		<!-- row -->
		<div class="row">
			...
			<div class="col-md-12 table-height">
                ...
                <div class="panel panel-default" ng-controller="mul_view_form">
            	 <form class="form-horizontal forms_ec" url="services/settings/segment_mul_view" name="userForm" method="post" novalidate>
                        ...
                        <tr>
                            <th ng-controller="segmentdropCntrl">
                             	<select name="segmentAlias" placeholder="Segment" class="SlectBox form-control" ng-model="selectt.id" data-ng-change="listSorting()">
                                    <option value="" style="display:none">Segment Name</option>
                             ...
                             <th>
                                <a class="tktid">Segement Code&nbsp;<span class="arrow caret"></span></a>
                                <input type="text" class="droptxt1 hidden" name="segmentCode" style="display:block; border:none; color:#000;" placeholder="Type keyword" data-ng-keyup="listSorting()">
                    ...
                    <div class="div-table-content">
                        <table class="table table-condensed table-hover">
                            <tbody>
                                <tr class="tktBackground" ng-repeat="data in datas.segmentDetails">
                                	<td ng-click="segmentview(data.segment_alias)"><span tooltip-placement="top" tooltip="Click to know details of {{data.segment_name}}">{{data.segment_name}}</span></td>
                                    <td>{{data.segment_code}}</td>
                                </tr>
                           </tbody>
                            <tfoot ng-if="datas.segmentDetails.length=='0'"><tr><td>No Records</td></tr></tfoot>
                        </table>
                    </div>
                    <!-- #end data table -->	
                     <div class="panel-footer clearfix" ng-if="datas.segmentDetails.length!='0'">
                        <div class="col-md-4">
...
<div id="ticketviesw">
	<div class="site-settings ticketviesw clearfix  col-xs-6 col-md-4 col-lg-4 col-sm-4 floating-sidebar" ng-class="{'open': segment_open}" custom-scrollbar>
        <div class="sidebar-wrap text-uppercase">
                <div class="group clearfix head tkt-heading">
                    <div class="left">
                    <span class="ion ion-close-round mr10 tktviewClose" ng-click="removesegmentView()"></span>
                        <span><strong>view segment</strong></span>
                    </div>
                    <div class="right" ng-controller="ModalDemoCtrl">
                        <div class="btn-group btn-group-sm">
                            <a href="services/settings/segment_print.php?alias={{singleViews.segment_alias}}" tooltip="Print" class="ml10" tooltip-placement="bottom"><span class="ion ion-android-print"></span></a>
                            <a href="services/settings/segment_download.php?alias={{singleViews.segment_alias}}" target="_blank" tooltip="Download" class="ml10" tooltip-placement="bottom"><span class="ion ion-android-download"></span></a>
                        </div>
                   </div>
                </div>
            	<div class="panel-body">
                    <div class="row tkt-panel">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6">
                          <h6>Segment Code</h6>
                          <span class="fnt-size-11">{{singleViews.segment_code}}</span>
                        </div>
                    </div>
              	</div>
            </div>
