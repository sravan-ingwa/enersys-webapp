...
<div ng-controller="itemsCtrl">
   <div class="panel panel-lined table-responsive panel-hovered mb10" style="" >
        ...
        <ol class="breadcrumb breadcrumb-small right" style="margin-bottom:0px;">
            <li><a href="exports/{{singleViews.file_name}}.xlsx" ng-click="itemsexport()" class="padding-10 export-btn">Export</a></li>
        </ol>
   </div>
		<!-- row -->
		<div class="row">
			...
			<div class="col-md-12 table-height">
                ...
                <div class="panel panel-default" ng-controller="mul_view_form">
            	 <form class="form-horizontal forms_ec" url="services/settings/item_code_mul_view" name="userForm" method="post" novalidate>
                    <table class="table table-condensed" >
                        <thead>
                        <tr>
                            <th>
                                <a class="tktid">Cell No./ Accessory&nbsp;<span class="arrow caret"></span></a>
                                <input type="text" class="droptxt1 hidden" name="itemDesc" style="display:block; border:none; color:#000;" placeholder="Type keyword" data-ng-keyup="listSorting()">
                            ...
                            <th class="hidden-xs">
                                ...
                                <input type="text" class="droptxt1 hidden" name="sjoNo" style="display:block; border:none; color:#000;" placeholder="Type keyword" data-ng-keyup="listSorting()">
                                <span class="ion ion-ios-close-outline inptClose hidden" data-ng-click="listSorting()"></span>
                            </th>
                        </tr>
                       </thead>
                    ...
                    <div class="div-table-content">
                        <table class="table table-condensed table-hover">
                            <tbody>
                                <tr class="tktBackground" ng-repeat="data in datas.itemDetails">
                                    ...
                                    <td class="hidden-xs hidden-sm">{{data.item_code}}</td>
                                    <td class="hidden-xs">{{data.sjo_no}}</td>
                                </tr>
                           </tbody>
                           <tfoot ng-if="datas.itemDetails.length=='0'"><tr><td>No Records</td></tr></tfoot>
                        </table>
                    </div>
                    <!-- #end data table -->	
    ...
    <div><button type="button" class="btn btn-info ion ion-plus compose-btn" tooltip="Addnew" tooltip-placement="top"  ng-click="itemsaddOpen()" md-ink-ripple></button></div>

<div class="site-settings ticketviesw clearfix  col-xs-6 floating-sidebar" ng-class="{'open': item_open}" custom-scrollbar>
        <div class="sidebar-wrap text-uppercase">
                <div class="group clearfix head tkt-heading">
                    <div class="left">
                    <span class="ion ion-close-round mr10 tktviewClose" ng-click="removeitemView()"></span>
                        <span><strong>View Stocks</strong></span>
                    </div>
                    <div class="right"  ng-controller="ModalDemoCtrl">
                        <div class="btn-group btn-group-sm">
                            <a href="" class="ml10" tooltip="Edit" tooltip tooltip-placement="bottom" ng-click="itemseditOpen()"><span class="fa fa-edit"></span></a>
                            <a href="services/settings/stocks_print.php?alias={{singleViews.item_code_alias}}" tooltip="Print" class="ml10" tooltip tooltip-placement="bottom"><span class="ion ion-android-print"></span></a>
                            <a href="services/settings/stocks_download.php?alias={{singleViews.item_code_alias}}" target="_blank" tooltip="Download" class="ml10" tooltip tooltip-placement="bottom"><span class="ion ion-android-download"></span></a>
                        </div>
                    </div>
                </div>
            	<div class="sidebar-wrap">
                    <tabset justified="true" class="tabs-linearrow">
                        <tab>
                            <tab-heading>Stock Details</tab-heading>
                            <div class="chat-tab tab clearfix">
                             	<div class="row tkt-panel">
                                    <div class="col-lg-4 col-md-4 col-sm-4">
                                      <h6>Item Type</h6>
                                      <span class="fnt-size-11">{{singleViews.item_type}}</span>
                                    </div>
                                    <div class="col-lg-4 col-md-4 col-sm-4">
                                      <h6>Item Code</h6>
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-4">
                                      <h6 ng-if="singleViews.item_type=='CELLS'">Cell Number</h6>
                                      <h6 ng-if="singleViews.item_type=='ACCESSORIES'">Quantity</h6>
                                      <span class="fnt-size-11">{{singleViews.item_description}}</span>
                                    </div>
                                </div>
                                <div class="row tkt-panel">
                                    <div class="col-lg-4 col-md-4 col-sm-4">
                                      <h6>Sjo Number</h6>
                                      <span class="fnt-size-11">{{singleViews.sjo_no}}</span>
                                    </div>
                                    <div class="col-lg-4 col-md-4 col-sm-4">
                                      <h6>Invoice number</h6>
                                      <span class="fnt-size-11">{{singleViews.invoice_no}}</span>
                                    </div>
                                    <div class="col-lg-4 col-md-4 col-sm-4">
                                      <h6>Invoice Date</h6>
                                      <span class="fnt-size-11">{{singleViews.invoice_date}}</span>
                                    </div>
                                </div>
                            </div>
                        </tab>
                        <tab>
                            ...
                            <div class="col-md-12 table-height">
                                ...
                                <form class="form-horizontal forms_single" url="" name="userForm" method="post" novalidate>
                                    <table class="table table-condensed" >
                                        <thead>
                                        <tr>
                                            <th>
                                                <a class="tktid">History&nbsp;<span class="arrow caret"></span></a>
                                                <input type="text" class="droptxt1 hidden" name="action" style="display:block; border:none; color:#000;" placeholder="Type keyword" data-ng-keyup="listSorting()">
                                                <span class="ion ion-ios-close-outline inptClose hidden"></span>
                                            </th>
                                            <th>
                                                <a class="tktid">Login Details&nbsp;<span class="arrow caret"></span></a>
                                                <input type="text" class="droptxt1 hidden" name="dateTime" style="display:block; border:none; color:#000;" placeholder="Type keyword" data-ng-keyup="listSorting()">
                                                <span class="ion ion-ios-close-outline inptClose hidden"></span>
                                            </th>
                                        </tr>
                                      </thead>
                                    ...
                                    <div class="div-table-content">
                                         <table class="table table-condensed table-hover">
                                           ...
                                           <tfoot ng-if="datasingle.usertrackingDetails.length=='0'"><tr><td>No Records</td></tr></tfoot>
                                        </table>
                                    </div>	
                                     <div class="panel-footer clearfix" ng-if="datasingle.usertrackingDetails.length!='0'">
                                        ...
                                        <select class="form-control page-count"  name="page_no" ng-model="selectt.id" data-ng-change="listSorting()">
                                            <option value="" style="display:none">1</option>
                                            <option ng-repeat="pagess in datasingle.pages" value="{{pagess.pagx}}">{{pagess.pagx}}</option>
                                        </select> 
                                        </div>
                                        </div>
                                        <div class="col-md-4">
