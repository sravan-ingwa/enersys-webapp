...
<div class="modal-style" ng-controller="sitetypeEditCntl">	<!-- wrapper for specific style -->
	<div class="modal-header clearfix">
		<h4 class="modal-title">Edit Site Type</h4>
	...
	<div class="modal-body" ng-controller="addingform">
        ...
        <form class="form-horizontal forms_add" reset-directive="singleViews" name="sitetypeForm" data-went="#/settings/sitetype/sitetype_view" method="post" url="services/settings/sitetype_update" ng-submit="sendPost()" novalidate>
                <input name="site_type_alias" value="{{singleViews.site_type_alias}}" type="hidden">
                <div class="row form-group">
                    <div class="col-sm-10 col-sm-offset-1 mb10" ng-controller="segmentdropCntrl">
                		<label class="selectlabel">Segment</label>
                         <select class="form-control testSelAll2 editselectdrop" name="segment_alias" ng-model="segments" required="required">
                    ...
                    <div class="col-sm-10 col-sm-offset-1">
                        <md-input-container flex="" class="md-default-theme md-input-has-value">
                            <label for="input_00A">Site Type</label>
                            <input name="site_type" value="{{singleViews.site_type}}" ng-model="singleViews.site_type" class="ng-pristine ng-valid md-input ng-touched" required="required">              
                        </md-input-container>
                     ...
                     <div class="col-sm-6 col-sm-offset-5">
                            ...
                            ng-disabled="sitetypeForm.segment_alias.$dirty && sitetypeForm.segment_alias.$invalid ||
                             sitetypeForm.site_type.$dirty && sitetypeForm.site_type.$invalid">Update</button>
