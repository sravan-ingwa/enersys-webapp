...
.SumoSelect > .optWrapper.open {top:33px !important;}
    ...
    <div class="modal-style">	<!-- wrapper for specific style -->
        <div class="modal-header clearfix">
            <h4 class="modal-title">Export Warehouse</h4>
            <span class="close ion ion-android-close" ng-click="modalClose()"></span>
        </div>
        <div class="modal-body" ng-controller="addingform">
            <form class="form-horizontal forms_add" data-went="#/settings/warehouse/warehouse_view" method="post" url="services/settings/warehouse_export" ng-submit="sendPost()" novalidate>
