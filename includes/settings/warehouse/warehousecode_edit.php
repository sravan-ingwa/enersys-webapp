...
<div ng-controller="warehouseEditCntl">
	<div class="modal-header clearfix">
		<h4 class="modal-title">Edit Warehouse Code</h4>
	...
	<div class="modal-body" ng-controller="addingform">
        ...
        <form class="form-horizontal forms_add" reset-directive="singleViews" name="warehouseForm" data-went="#/settings/warehouse/warehouse_view" method="post" url="services/settings/warehouse_update" ng-submit="sendPost()" novalidate>
                <input name="wh_alias" value="{{singleViews.wh_alias}}" type="hidden">
                <div class="row form-group">
                   ...
                   <div class="col-sm-10 col-sm-offset-1 mb10">
                		<label class="selectlabel">State</label>
                         <select class="form-control testSelAll2 editselectdrop" name="state_alias" id="state" ng-model="states" required="required">
                    ...
                    <div class="col-sm-10 col-sm-offset-1">
                        <md-input-container flex="" class="md-default-theme md-input-has-value">
                            <label for="input_00D">Warehouse Code</label>
                            <input value="{{singleViews.wh_code}}" ng-model="singleViews.wh_code" class="ng-pristine ng-valid md-input ng-touched" name="wh_code" id="input_00B" tabindex="0" aria-invalid="false" required="required">
                        </md-input-container>
                    ...
                    <div class="col-sm-10 col-sm-offset-1">
                        <md-input-container flex="" class="md-default-theme md-input-has-value">
                            <label for="input_00D">Warehouse Description</label>
                    ...
                    <div class="col-sm-10 col-sm-offset-1">
                        <md-input-container flex="" class="md-default-theme md-input-has-value">
                            <label for="input_00D">Warehouse Address</label>
                            <input value="{{singleViews.wh_address}}" ng-model="singleViews.wh_address" class="ng-pristine ng-valid md-input ng-touched" name="wh_address" id="input_00B" tabindex="0" aria-invalid="false" required="required">
                        </md-input-container>
                   ...
                   <div class="col-sm-10 col-sm-offset-1 mb10">
                		<label class="selectlabel">Road Permit</label>
                         <select class="form-control testSelAll2 editselectdrop" name="road_permit" id="road" ng-model="road_permit" required="required">
                            <option value="" selected="selected" disabled="disabled">Road Permit</option>
                            <option value="0" ng-selected="singleViews.road_permit==0">NOT REQUIRED</option>
                            <option value="1" ng-selected="singleViews.road_permit==1">REQUIRED</option>
                        </select>
                     ...
                     <div class="col-sm-6 col-sm-offset-5 mt10">
                            <button type="submit" click-once class="btn btn-info btn-sm" 
                             ng-disabled="warehouseForm.zone_alias.$dirty && warehouseForm.zone_alias.$invalid ||
                             warehouseForm.state_alias.$dirty && warehouseForm.state_alias.$invalid ||
                             warehouseForm.employee_alias.$dirty && warehouseForm.employee_alias.$invalid ||
                             warehouseForm.wh_code.$dirty && warehouseForm.wh_code.$invalid ||
                             warehouseForm.description.$dirty && warehouseForm.description.$invalid ||
                             warehouseForm.road_permit.$dirty && warehouseForm.road_permit.$invalid ||
                             warehouseForm.wh_address.$dirty && warehouseForm.wh_address.$invalid">Update</button>
