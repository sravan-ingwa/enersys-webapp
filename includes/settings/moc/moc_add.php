...
<div class="modal-style">
	<div class="modal-header clearfix">
		<h4 class="modal-title">Create MOC</h4>
	...
	<div class="modal-body" ng-controller="addingform">
        ...
        <form class="form-horizontal forms_add" name="mocForm" data-went="#/settings/moc/moc_view" method="post" url="services/settings/moc_add" ng-submit="sendPost()" novalidate>
                <div class="row form-group">
                    <div class="col-sm-10 col-sm-offset-1">
                        <md-input-container flex="" class="md-default-theme">
                            <label for="input_00D">MOC</label>
                            <input ng-model="moc_name" name="moc_name" class="ng-pristine ng-valid md-input ng-touched" required>
                        </md-input-container>
                         <span class="help-block" ng-show="mocForm.moc_name.$dirty && mocForm.moc_name.$invalid">
                            <span ng-show="mocForm.moc_name.$error.required">MOC Name is Required</span>
                        </span>
                    </div>
                    ...
                    <div class="col-sm-10 col-sm-offset-1 mb10">
                     ...
                     <div class="col-sm-6 col-sm-offset-5">
                            <button type="submit" click-once class="btn btn-info btn-sm subdisabled"  ng-disabled="mocForm.$invalid || mocForm.$pristine">Create</button>
