...
.SumoSelect > .optWrapper.open {top:33px !important;}
    ...
    <div class="modal-style">	<!-- wrapper for specific style -->
        <div class="modal-header clearfix">
            <h4 class="modal-title">Export District</h4>
            <span class="close ion ion-android-close" ng-click="modalClose()"></span>
        </div>
        <div class="modal-body" ng-controller="addingform">
            <form class="form-horizontal forms_add" data-went="#/settings/district/district_view" method="post" url="services/settings/district_export" ng-submit="sendPost()" novalidate>
              <div class="row form-group">
                   <div ng-controller="expzoneStateMulCntrl">
                        <div class="col-sm-10 col-sm-offset-1 mb20">
                   			<label class="selectlabel">Zone</label>
                            <select multiple="multiple" placeholder="Zone" name="zone_alias[]" class="testSelAll2 form-control selectdrop" ng-model="zones"  data-ng-change="dep_drop_mul_exp(zones)">
                                <option ng-repeat="zone in firstDrop" value="{{zone.alias}}">{{zone.name}}</option>
                            </select>
                        </div>
                        <div class="col-sm-10 col-sm-offset-1 mb20">
                           	<label class="selectlabel">State</label>
                            <select class="form-control testSelAll2 selectdrop" placeholder="State" name="state_alias[]" id="state" ng-model="states" data-ng-change="dep_drop_third(states)"  multiple="multiple">
                        ...
                        <div class="col-sm-10 col-sm-offset-1 mb20">
                            ...
                            <select class="form-control testSelAll2 selectdrop" placeholder="District" name="district_alias[]" id="district" ng-model="districts" multiple="multiple">
