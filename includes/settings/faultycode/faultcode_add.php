...
<div class="modal-style">	<!-- wrapper for specific style -->
	<div class="modal-header clearfix">
		<h4 class="modal-title">Create Fault Code</h4>
	...
	<div class="modal-body" ng-controller="addingform">
        ...
        <form class="form-horizontal forms_add" name="faultycodeForm" data-went="#/settings/faultycode/faultcode_view" method="post" url="services/settings/faultycode_add" ng-submit="sendPost()" novalidate>
                <div class="row form-group">
                    <div class="col-sm-10 col-sm-offset-1">
                        <md-input-container flex="" class="md-default-theme">
                            <label for="input_00D">Fault Code</label>
                            <input ng-model="faultcode" class="ng-pristine ng-valid md-input ng-touched" name="faulty_code" id="input_00A" tabindex="0" aria-invalid="false" required="required">
                        </md-input-container>
                    ...
                    <div class="col-sm-10 col-sm-offset-1">
                     ...
                     <div class="col-sm-6 col-sm-offset-5">
                            <button type="submit" click-once class="btn btn-info btn-sm" ng-disabled="faultycodeForm.$invalid || faultycodeForm.$pristine">Create</button>
