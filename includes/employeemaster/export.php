...
<div class="modal-style">
	<div class="modal-header clearfix">
		<h4 class="modal-title">Export Employee Master</h4>
		<span class="close ion ion-android-close" ng-click="modalClose()"></span>
	</div>
	<div class="modal-body" ng-controller="addingform">
		<form class="form-horizontal forms_add" data-went="#/employeemaster" method="post" url="services/employeemaster/employeemaster_export" ng-submit="sendPost()" novalidate>
            		<div class="row form-group" ng-controller="expzoneStateMulCntrl">
                        ...
                        <div class="col-sm-4" ng-controller="assetnamedropCntrl">
                             <label class="selectlabel">Asset Name</label>
                             <select class="form-control testSelAll2" placeholder="Asset Name" name="asset_alias[]" ng-model="asset_alias" multiple="multiple">
                              <option ng-repeat="asset in firstDrop" value="{{asset.alias}}" >{{asset.name}}</option>
                            </select>
                        </div>
                    </div>
                 	<div class="row form-group" ng-controller="departmentdropCntrl">
                        <div class="col-sm-4">
                             <label class="selectlabel">Department</label>
                             <select class="form-control testSelAll2 selectdrop" placeholder="Department" name="department_alias[]" ng-model="department" multiple="multiple">
                       ...
                       <div class="col-sm-4" ng-controller="empstatusdropCntrl">
                             <label class="selectlabel">Status</label>
                              <select class="form-control testSelAll2 selectdrop" placeholder="Status" name="status[]" ng-model="status" multiple="multiple">
