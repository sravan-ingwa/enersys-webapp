...
<div class="modal-style" ng-controller="bod_S_AddCtrl">	
	...
	<div class="modal-body">
		<form class="form-horizontal forms_update" name="expenseRequest" method="post" url="services/expense_tracker/ser_bod_single_add" ng-submit="addRequest()" novalidate>
