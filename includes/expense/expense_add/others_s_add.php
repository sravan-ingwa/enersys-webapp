...
<div class="modal-style" ng-controller="oth_S_AddCtrl">	
	...
	<div class="modal-body">
		<form class="form-horizontal forms_update" name="expenseRequest" method="post" url="services/expense_tracker/ser_oth_single_add" ng-submit="addRequest()" novalidate>
                ...
                <div class="col-sm-12">
                  <div class="row form-group" ng-repeat="field in forms">  
                   <div class="panel panel-info mb10" ng-repeat="(key,type) in field.itemtype">
                    ...
                    <div class="col-md-4 right mt5"> <input readonly="readonly" class="form-control tlomt"  placeholder="Total Other's" name="fare_total_oth"></div>
                    <a href="" class="text-info fnt-20 ml10" ng-click="addFields(field,$event)" fnt-20> New Field : <span class="ion ion-plus-circled fnt-20"></span></a>
                </div>
               </div>
            </div>
           <div class="row form-group"> 
