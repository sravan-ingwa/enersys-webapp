...
<div class="modal-style" ng-controller="oth_S_EditCtrl">	<!-- wrapper for specific style -->
	...
	<div class="modal-body" ng-controller="updatingCntrl">
		<form class="form-horizontal forms_update" name="advanceRequest" data-went="#/advances" method="post" url="services/expense_tracker/ser_oth_single_edit" ng-submit="upadteRequest()" novalidate>
                ...
                <div class="row form-group">
                    ...
                    <div class="col-sm-4" ng-controller="DatepickerDemoCtrl">
                        <md-input-container flex="" class="md-default-theme md-input-has-value">
                            ...
                            <input type="text" value="{{editViews.checked_date}}" readonly="readonly" ng-model="editViews.checked_date" name="odate" class="border-bottom" placeholder="DD-MM-YYYY" datepicker-popup="{{format}}" ng-click="open($event)" ng-focus="open($event)" is-open="opened" min-date="minDate" max-date="dt" datepicker-options="dateOptions" date-disabled="disabled(date, mode)"  show-button-bar="false"/>  
                        </md-input-container>
                    </div> 
                    <div class="col-sm-4 filesRow margin-none" ng-controller="fileUploadCtrl">  
                 ...
                 <div class="row form-group">   
                    <div class="col-sm-4" ng-controller="ticketDropCtrl">
                        ...
                        <select class="form-control SlectBox" placeholder="Ticket ID" name="ticket_ot" id="ticket_id" ng-model="ticket_id" >
                    ...
                    <div class="col-sm-4">
                        <md-input-container flex="" class="md-default-theme md-input-has-value">
                            ...
                            <input value="{{editViews.dpr_number}}" name="dprNum_ot">
                        </md-input-container>
                    </div>
                    <div class="col-sm-4">
                        <md-input-container flex="" class="md-default-theme md-input-has-value">
                            <label for="input_00B">Amount</label>
                            <input value="{{editViews.amount}}" class="amtt tamfor tlom amntDig" ng-keypress="onlyIntegers($event)" ng-keyup="onlyIntegers($event); amnt();" ng-focus="onlyIntegers($event)" name="oamt" autocomplete="off">
                        </md-input-container>
                    </div>
                 </div>
            <div class="row form-group"> 
