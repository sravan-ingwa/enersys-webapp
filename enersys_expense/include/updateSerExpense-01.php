	...
	<div class="panel-body">
           ...
           <?php
			 $l = 1; foreach($lconveyance as $conveyance1){$tamtll+=$conveyance1['amount'];
						 if(getArea($conveyance1['district_alias'])==0){
							 $disp_area='Plain Area'; $amount_appli = 0.07;
						}else if(getArea($conveyance1['district_alias'])==1){
								 $disp_area='Hilly area'; $amount_appli = 0.09;
						}?>
                   <div id="localConv_<?php echo $l;?>" class="panel panel-default tbformm" >
                   ...
                   <?php $getdt=getDistricts($conveyance1['state_alias']);if($getdt!=0){foreach($getdt as $drec){echo "<option value='".$drec['district_alias']."' ".checkSelected($drec['district_alias'],$conveyance1['district_alias']).">".$drec['district_name']."</option>";}}else echo "<option disabled='disabled'>Add District</option>";?>
                            ...
                            <div class="col-md-3 form-group lclHide <?php if($conveyance1['bucket'] == 1) echo "hidden";?>">
                                ...
                                <input type="text" class="form-control qnty ocap" name="quantityCell[]" placeholder="Quantity" <?php if($conveyance1['bucket'] == 0){?> value="<?php echo $conveyance1['quantity'];?>" <?php } ?>/>
                            </div>
                            <div class="col-md-3 form-group lclHide <?php if($conveyance1['bucket'] == 1) echo "hidden";?>">
                                <label class="ocap">No.of Kilometers : </label>   
                                <input type="text" class="form-control numKilo ocap" name="numKilometers[]" placeholder="No.of Kilometers" <?php if($conveyance1['bucket'] == 0){?> value="<?php echo $conveyance1['km'];?>" <?php }?>/>
                            </div>
                            <div class="col-md-3 form-group lclHide <?php if($conveyance1['bucket'] == 1) echo "hidden";?>">
               ...
               <div id="localConv_<?php echo ($lcnt+1);?>" class="panel panel-default tbformm" >
                    	<div class="panel-heading panlbakg">
                    	...
                    	<div class="row">
                            ...
                            <div class="col-md-3 form-group lclHide">
                                <label class="ocap">Quantity : </label>   
                                <input type="text" class="form-control qnty ocap" name="quantityCell[]" placeholder="Quantity" />
                            </div>
                            <div class="col-md-3 form-group lclHide">
                                <label class="ocap">No.of Kilometers : </label>   
                                <input type="text" class="form-control numKilo ocap" name="numKilometers[]" placeholder="No.of Kilometers"/>
                            </div>
                            <div class="col-md-3 form-group lclHide">
                                <label class="ocap">Amount Appilicable : </label>   
        ...
        <div class="col-lg-12 form-group">
            ...
            <div class="clearfix">
                <div class="column">
                    <table class="table table-bordered" id="fare_tab">
                        <thead><tr class="blue cust"><th>Zone</th><th>State</th><th>District</th><th>Visit: Start Date:</th><th>Visit: End Date:</th><th>Hotel Name</th><th>Amount</th><th>Ticket ID</th><th>DPR Number</th></tr></thead>
                      <?php if($lodging!=0){?>
                       <tbody>
                ...
                <option value="0" selected="selected" disabled="disabled">Select Zone</option>
                   ...
                   <?php $getdt=getDistricts($lodging1['state_alias']);if($getdt!=0){foreach($getdt as $drec){echo "<option value='".$drec['district_alias']."' ".checkSelected($drec['district_alias'],$lodging1['district_alias']).">".$drec['district_name']."</option>";}}else echo "<option disabled='disabled'>Add District</option>";?>
                               ...
                               <td><input type="text" class="form-control expense_dates checkin cddl bg-white" tabindex="0" value="<?php echo date("d-m-Y", strtotime($lodging1['check_in'])); ?>" name="checkin[]" placeholder="DD-MM-YYYY"/></td>
                                <td><input type="text" class="form-control expense_dates checkout cddl bg-white" tabindex="0" value="<?php echo date("d-m-Y", strtotime($lodging1['check_out'])); ?>" name="checkout[]" placeholder="DD-MM-YYYY"/></td>
                ...
                <option value="0" selected="selected">Zone</option>
                    ...
                    <option value="0" selected="selected" disabled="disabled" class="depsel">State</option>
                     ...
                     <option value="0" selected="selected" disabled="disabled" class="depsel">District</option>
                                ...
                                <td><input type="text" class="form-control expense_dates checkin cddl bg-white" name="checkin[]" placeholder="DD-MM-YYYY" readonly/></td>
                                <td><input type="text" class="form-control expense_dates checkout cddl bg-white" name="checkout[]" placeholder="DD-MM-YYYY" readonly/></td>
        ...
        <div class="col-lg-12 form-group">
            ...
            <div class="clearfix">
                <div class="column">
                    <table class="table table-bordered" id="fare_tab">
                        <thead><tr class="blue cust"><th>Zone</th><th>State</th><th>District</th><th>Visit: Start Date:</th><th>Visit: End Date:</th><th>Amount</th><th>Ticket ID</th><th>DPR Number</th></tr></thead>
                       <?php if($boarding!=0){?>
                        <tbody>
                ...
                <option value="0" selected="selected" disabled="disabled">Zone</option>
                   ...
                   <?php $getdt=getDistricts($boarding1['state_alias']);if($getdt!=0){foreach($getdt as $drec){echo "<option value='".$drec['district_alias']."' ".checkSelected($drec['district_alias'],$boarding1['district_alias']).">".$drec['district_name']."</option>";}}else echo "<option disabled='disabled'>Add District</option>";?>
                                ...
                                <td><input type="text" class="form-control expense_dates checkin cddl bg-white" tabindex="0" value="<?php echo date("d-m-Y", strtotime($boarding1['check_in'])); ?>" name="checkinb[]" placeholder="DD-MM-YYYY"/>
</td>
                                <td><input type="text" class="form-control expense_dates checkout cddl bg-white" tabindex="0" value="<?php echo date("d-m-Y", strtotime($boarding1['check_out'])); ?>" name="checkoutb[]" placeholder="DD-MM-YYYY"/></td>
                ...
                <option value="0" selected="selected">Zone</option>
                    ...
                    <option value="0" selected="selected" disabled="disabled" class="depsel">State</option>
                     ...
                     <option value="0" selected="selected" disabled="disabled" class="depsel">District</option>
                                ...
                                <td><input type="text" class="form-control expense_dates checkin cddl bg-white" name="checkinb[]" placeholder="DD-MM-YYYY" readonly/></td>
                                <td><input type="text" class="form-control expense_dates checkout cddl bg-white" name="checkoutb[]" placeholder="DD-MM-YYYY" readonly/></td>
        ...
        <div class="col-lg-12 form-group">
            ...
            <div class="clearfix">
                <div class="column">
                    <table class="table table-bordered" id="fare_tab">
                        <thead><tr class="blue cust"><th>Description</th><th>Amount</th><th>Date</th><th>Files (No special characters in file name)</th><th>Ticket ID</th><th>DPR Number</th></tr></thead>
...
$(document).on('change','.zone_change',function(){
	var sib =  $(this).parent().siblings();
	ajaxSelect($(this),sib);
	ajaxAmount($(this).parents('.tbform'));
	ajaxAmount($(this).parents('.tbformm'));
...
/*
$(document).on('change','.ttcm',function(){
		$(".ttcm").each(function(){lctamt+=Number($(this).val()); alert(lctamt);});
});
*/
                    ...
                    success: function(result) {	
						...
						if (type == "area") {							
							if(result == 0){
								...
								/*}else {
								$("[data-ref=" + dataref + "]").find(".appli_change").val(disp_amnt);
								}*/
							}else if(result == 1){
								var disp = 'Hilly area';
								var disp_amnt = '0.09';
	...
	function ajaxAmount(tr) {
		...
		var appli = $("[data-ref=" + dataref + "]").find(".appli_change").val(); 
		alert('bucket=' + bucket + '&zonesel=' + zoneval + '&statesel=' + stateval + '&dissel=' + districtval + '&weight=' + weight + '&qnty=' + qnty + '&km=' + km + '&appli=' + appli+'&ref='+ref);
		if(bucket != ""){
                $.ajax({
                    type: "POST",
                    url: "ajaxAmount.php",
                    data: 'bucket=' + bucket + '&zonesel=' + zoneval + '&statesel=' + stateval + '&dissel=' + districtval + '&weight=' + weight + '&qnty=' + qnty + '&km=' + km + '&appli=' + appli+'&ref='+ref,
                    cache: false,
					async:false,
                    success: function(res) {
						...
						/*}else {
						$("[data-ref=" + dataref + "]").find("."+ref).val($.trim(res));
						}*/
						//data-ref="1"
					//$(".fare2").find('tr')
						//tr.find("."+ref).val($.trim(res));
