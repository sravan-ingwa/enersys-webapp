...
<div class="panel panel-primary">
	...
	<div class="panel-body">
        ...
        <div class="col-md-4 form-group">
            ...
            <input class="form-control" type="text" value="" placeholder="Employee ID" readonly/>
        </div>
        <div class="col-md-4 form-group">
            <label>Employee Name: </label>
            <input class="form-control" type="text" value="" placeholder="Employee Name" readonly/>
        </div>
        <div class="col-md-4 form-group">
            <label>Grade: </label>
            <input class="form-control" type="text" value="" placeholder="Grade" readonly/>
        </div>
        <div class="col-md-4 form-group">
                    ...
                    <table class="table table-bordered" id="fare_tab" style="width:2000px !important;">
                        ...
                        <tbody id='fare5'>
                            <tr class="tbform">
                                ...
                                <td>
                                    <select class="form-control showgradedesg depSel" tabindex="2" required="required" name="state[]" autofocus="autofocus">
                                ...
                                <td>
                                     <select class="form-control showgradedesg depSel" tabindex="3" required="required" name="district[]" autofocus="autofocus">
                                 ...
                                 <td>
                                    <input type="text" class="form-control" name="area[]" placeholder="Area" readonly="readonly"/>
                                </td>
                                <td>
                                ...
                                <td class="lclHide">
                                     <select class="form-control" tabindex="3" required="required" name="cap[]" autofocus="autofocus">
                                        <option value="" selected="selected" disabled="disabled">Capacity</option>
                                     </select>
                                </td>
                                ...
                                <td class="lclHide"><input type="text" class="form-control qnty" name="qnty[]" placeholder="Quantity"/></td>
