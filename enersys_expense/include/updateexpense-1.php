    ...
    <div class="panel panel-primary">
        ...
        <p class='alerta' role='alert'></p>
            ...
            <div class="col-md-4 form-group">
                ...
                <input type="text" tabindex="7" class="form-control" id="visitFromDate" value="<?php echo noofDays($expList[0]['period_of_visit_from'],$expList[0]['period_of_visit_to']);?>" placeholder="No. of days" readonly="readonly" />
            </div>
            <div class="col-md-4 form-group">
                ...
                <div class="clearfix">
                    <div class="column">
                        <table class="table table-bordered" id="fare_tab">
                            ...
                            <tbody id='fare0'>
                            <?php if($lconveyance!=0){foreach($lconveyance as $conveyance1){$tamt121+=$conveyance1['amount'];?>
                                ...
                                <?php }}else echo "<tr><td colspan='5' align='center'>No Records</td></tr>";?>
                            </tbody>
                        </table>
                        <div class="col-md-4 pull-right"><input type="text" class="form-control tcmt" placeholder="Total Local Conveyance" value="<?php if($tamt121!=0) echo $tamt121;?>"  readonly="readonly"/></div>
                    </div>
                </div>
            </div>
    <div class="col-lg-12 form-group">
	...
	<div class="col-lg-12 form-group">
        ...
        <div class="clearfix">
            <div class="column">
                <table class="table table-bordered" id="fare_tab">
                    ...
                    <tbody id='fare1'>
                        ...
                        <tr class="tbform">
                            ...
                            <td><input type="text" class="form-control" value="<?php echo $boarding1['state'];?>" placeholder="Hotel Name" readonly="readonly"/></td>
                ...
                <div class="col-md-4 pull-right"><input type="text" class="form-control blamt" placeholder="Total Lodging" value="<?php if($bamtl!=0) echo $bamtl;?>" readonly="readonly"/></div>
            </div>
        </div>
    </div>
    <div class="col-lg-12 form-group">
