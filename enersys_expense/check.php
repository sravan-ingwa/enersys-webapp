...
.cntr {
  ...
  <body>
    <div id="wrap">
        <form id="regform" name="registerationform" method="POST" action="welcome.html" novalidate>
            <table border="1" cellpadding="2" cellspacing="0" style="border-collapse: collapse" width="300">
                <tr>
                    <td>First Name:</td>
                    <td class="cntr">
                        <input type="text" name="fnametxt" size="20">
                    </td>
                </tr>
                <tr>
                    <td>Second Name:</td>
                    <td class="cntr">
                        <input type="text" name="snametxt" size="20">
                    </td>
                </tr>
                <tr>
                    <td>User Name:</td>
                    <td class="cntr">
                        <input type="text" name="unametxt" size="20">
                    </td>
                </tr>
                <tr>
                    <td>Email Address:</td>
                    <td class="cntr">
                        <input type="text" name="emailtxt" size="20">
                    </td>
                </tr>
                <tr>
                    <td>Password :</td>
                    <td class="cntr">
                        <input type="password" name="pwdtxt" size="20">
                    </td>
                </tr>
                <tr>
                    <td>Confirm :</td>
                    <td class="cntr">
                        <input type="password" name="cpwdtxt" size="20">
                    </td>
                </tr>
            </table>
            <input id="reg" name="reg" type="button" onclick="regvalidate(this.form)" value="Register Now">
        </form>
        <div id="une" class="a13B"></div>
    </div>
</body>
...
function regvalidate(formObj) {
    ...
    for (var i = 0; i < allInputs.length; i++) {
        if (allInputs[i].name != "reg") // ignore submit button
        {
            if (allInputs[i].value == "") {
                ...
                if (currentBrdObj) {
                    currentBrdObj.style.border = "2px solid #CCC";
                }
    ...
    if ((formObj.pwdtxt.value) != (formObj.cpwdtxt.value)) {
        ...
        formObj.pwdtxt.value = "";
        formObj.pwdtxt.style.border = "";
        formObj.cpwdtxt.value = "";
        formObj.cpwdtxt.style.border = "";
        return;
    }
