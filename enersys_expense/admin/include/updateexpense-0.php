...
<div class="panel panel-primary">
    ...
    <p class='alerta' role='alert'></p>
		...
		<div class="col-md-4 form-group">
			...
			<input type='text' class="form-control dpd1" tabindex="0" autofocus="autofocus" name="visitFromDate"  value="<?php echo date("d-m-Y", strtotime($expList[0]['period_of_visit_from'])); ?>"  placeholder="Period of Visit From" />
		</div>
		<div class="col-md-4 form-group">
		...
		<div class="col-md-4 form-group">
			...
			<input type="text" class="form-control" id="visitFromDate" placeholder="No. of days" readonly="readonly"/>
		</div>
		<div class="col-md-4 form-group">
                           ...
                           <?php foreach($conveyance as $conveyance1){$tamt+=$conveyance1['amount'];?>
                            <tr class="tbform">
                                <td>
                                    ...
                                    <input type="text" tabindex="0" class="form-control expense_dates" name="dot[]" value="<?php echo date("d-m-Y", strtotime($conveyance1['date_of_travel'])); ?>" />
                                </td>
                                <td>
                        ...
                        <tbody id='fare0'>
                            <tr class="tbform">
                                <td>
                                    ...
                                    <input type="text" class="form-control expense_dates" tabindex="0" name="dot[]" placeholder="DD-MM-YYYY"/>
                                </td>
                                <td>
						...
						<tbody>
							...
							<tr class="tbform">
                                <td>
                                    ...
                                    <input type="text" class="form-control expense_dates" tabindex="0" value="<?php echo date("d-m-Y", strtotime($conveyance1['date_of_travel']));?>" name="dot_l[]" placeholder="DD-MM-YYYY"/>
                                </td>
                                <td>
					...
					<tbody id='fare5'>
						<tr class="tbform">
                            <td>
                                ...
                                <input type="text" class="form-control expense_dates" tabindex="0" name="dot_l[]" placeholder="DD-MM-YYYY"/>
                            </td>
                            <td>
                                <select class="form-control" tabindex="0" name="mot_l[]" id="mot">
                                    <option value="0">Mode of travel</option>
				...
				<table class="table table-bordered" id="fare_tab">
					...
					<tbody>
						...
						<tr class="tbform">
                            ...
                            <td>
                                <input type="text" class="form-control expense_dates" tabindex="0" value="<?php echo date("d-m-Y", strtotime($lodging1['check_in'])); ?>" name="checkin[]" placeholder="DD-MM-YYYY"/>
                            </td>
                            <td>
                                <input type="text" class="form-control expense_dates" tabindex="0" value="<?php echo date("d-m-Y", strtotime($lodging1['check_out'])); ?>" name="checkout[]" placeholder="DD-MM-YYYY"/>
                            </td>
                            <td class="changw">
                                <input type="text" class="form-control" name="hotelName[]" tabindex="0" value="<?php echo $lodging1['hotel_name'];?>" placeholder="Hotel Name"/>
                            </td>
                            <td>
					...
					<tbody id='fare1'> 
						<tr class="tbform">
                            ...
                            <td>
                                <input type="text" class="form-control expense_dates" tabindex="0" name="checkin[]" placeholder="DD-MM-YYYY"/>
                            </td>
                            <td>
                                <input type="text" class="form-control expense_dates" tabindex="0" name="checkout[]" placeholder="DD-MM-YYYY"/>
                            </td>
							<td class="changw"></td>
                            <td>
				...
				<table class="table table-bordered" id="fare_tab">
					...
					<tbody>
						...
						<tr class="tbform">
                            ...
                            <td>
                                <input type="text" class="form-control expense_dates" tabindex="0" value="<?php echo date("d-m-Y", strtotime($other_expenses1['checked_date'])); ?>"  name="odate[]" placeholder="DD-MM-YYYY"/>
                            </td>
                            <td>
                    ...
                    <tbody id='fare2'>  
                        <tr class="tbform">
                            ...
                            <td>
                                <input type="text" class="form-control expense_dates" tabindex="0" name="odate[]" placeholder="DD-MM-YYYY"/>
                            </td>
                            <td>
                                <input type="hidden" class="form-control" name="ofile[]" value="0"/>
                                <input type="file" class="form-control" tabindex="0" name="ofile[]"/>
