...
else if($loadType=="District"){$sql="select district_alias, district_name from ec_district where state_alias='".$loadId."' AND flag='0' ORDER BY district_name";}else if($loadType=="Area"){
$sql="select area from ec_district where district_alias='".$loadId."' AND flag='0' ORDER BY district_name";	
}
