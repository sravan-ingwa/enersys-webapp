...
-->	
	...
	$(document).on('click','.updatex',function (event){//alert("qqqq");
		event.preventDefault();
		var chektoken=0;
		...
		$('select[name="zone_l[]"]').each(function(i,valuee){
			...
			$('input[name="checkinb[]"]').each(function(i,valuee){
				if($(this).val()!=""){ 
					...
					else if($('select[name="zone_bo[]"]:eq('+i+')').val()=== null){errelm=$('select[name="zone_bo[]"]:eq('+i+')').parent('td'); mess="Boarding: Select Zone";}
			...
			$('input[name="checkin[]"]').each(function(i,valuee){
				if($(this).val()!=""){ 
					if($('input[name="checkout[]"]:eq('+i+')').val()==''){errelm=$('input[name="checkout[]"]:eq('+i+')').parent('td'); mess="Lodging: Select Visit: End Date";}
					else if($('select[name="zone_ld[]"]:eq('+i+')').val()=== null){errelm=$('select[name="zone_ld[]"]:eq('+i+')').parent('td'); mess="Lodging: Select Zone";}
					else if($('select[name="state_ld[]"]:eq('+i+')').val()=== null){errelm=$('select[name="state_ld[]"]:eq('+i+')').parent('td'); mess="Lodging: Select State";}
...
/*		else if(ValidateExtension()=="0"){errelm=$('.tplanningreport').parent('div');mess="Upload Tour Report(Only .pdf file allowed and size not exceeding 1MB)";}
*/		else if($('input[name="others[]"]:eq(0)').val()=="" &&  $('select[name="zone_l[]"]:eq(0)').val()=="0" && $('input[name="checkinb[]"]:eq(0)').val()=="" && $('input[name="checkin[]"]:eq(0)').val()=="" && $('input[name="dot[]"]:eq(0)').val()==""){errelm=$(''); mess="Enter Atleast One Expense Details";}
		else{ 
			
				$('select[name="zone_l[]"]').each(function(i,valuee){ //alert('q');
				 if($(this).val()!="0"){  //alert($('select[name="state_l[]"]:eq('+i+')').val());
				 		 if($('select[name="state_l[]"]:eq('+i+')').val() != null){$('select[name="state_l[]"]:eq('+i+')').removeClass('error');}
						 if($('select[name="district_l[]"]:eq('+i+')').val() != null){$('select[name="district_l[]"]:eq('+i+')').removeClass('error'); }
						 if($('select[name="bucket[]"]:eq('+i+')').val() != null){$('select[name="bucket[]"]:eq('+i+')').removeClass('error'); }
						 if($('input[name="dot_l[]"]:eq('+i+')').val() != null){$('input[name="dot_l[]"]:eq('+i+')').removeClass('error');}
					...
					if($('select[name="state_l[]"]:eq('+i+')').val()=== null){$('select[name="state_l[]"]:eq('+i+')').addClass('error');$('select[name="state_l[]"]:eq('+i+')').removeAttr("style");
					mess="Local Conveyance: Select State";}
					else if($('select[name="district_l[]"]:eq('+i+')').val()=== null){$('select[name="district_l[]"]:eq('+i+')').addClass('error'); $('select[name="district_l[]"]:eq('+i+')').removeAttr("style"); mess="Local Conveyance: Select District";}
					else if($('select[name="bucket[]"]:eq('+i+')').val()=== null){$('select[name="bucket[]"]:eq('+i+')').addClass('error'); $('select[name="bucket[]"]:eq('+i+')').removeAttr("style");mess="Local Conveyance: Select Bucket";}
					else if($('select[name="bucket[]"]:eq('+i+')').val()!= null){
						 if($('input[name="dot_l[]"]:eq('+i+')').val() != null){$('input[name="dot_l[]"]:eq('+i+')').removeClass('error');}
						 if($('select[name="mot_l[]"]:eq('+i+')').val()!= null){$('select[name="mot_l[]"]:eq('+i+')').removeClass('error'); }
						 if($('input[name="from_l[]"]:eq('+i+')').val() !=''){$('input[name="from_l[]"]:eq('+i+')').removeClass('error');}
						 ...
						 if(($('input[name="amt_l[]"]:eq('+i+')').val()!='') && ($('input[name="amt_l[]"]:eq('+i+')').val()!='0')){$('input[name="amt_l[]"]:eq('+i+')').removeClass('error');}
							...
							if($('select[name="bucket[]"]:eq('+i+')').val()== "0"){ 
							 ...
							 if($('input[name="quantityCell[]"]:eq('+i+')').val() !=''){$('input[name="quantityCell[]"]:eq('+i+')').removeClass('error');}
								...
								if($('select[name="cap[]"]:eq('+i+')').val()==""){ 
									$('select[name="cap[]"]:eq('+i+')').siblings().find('.selectpicker').addClass('error');mess="Local Conveyance: Select Capacity";
								}
								else if($('input[name="quantityCell[]"]:eq('+i+')').val()==''){$('input[name="quantityCell[]"]:eq('+i+')').addClass('error');
								mess="Local Conveyance: Enter Quantity";}
								...
								else if($('select[name="mot_l[]"]:eq('+i+')').val()=== null){$('select[name="mot_l[]"]:eq('+i+')').addClass('error');$('input[name="mot_l[]"]:eq('+i+')').removeAttr("style");mess="Local Conveyance: Select Mode of travel";}
			...
			$('input[name="dot[]"]').each(function(i,valuee){
				if($(this).val()!=""){
					...
					else if(($('input[name="amt[]"]:eq('+i+')').val()=='') || ($('input[name="amt[]"]:eq('+i+')').val()=='0') ){errelm=$('input[name="amt[]"]:eq('+i+')').parent('td'); mess="Conveyance: Enter Amount";}
					else mess=1;
				}
			});
			...
			$('input[name="checkin[]"]').each(function(i,valuee){
				if($(this).val()!=""){ 
					...
					else if(($('input[name="lamt[]"]:eq('+i+')').val()=='') || ($('input[name="bamt[]"]:eq('+i+')').val()=='0')){errelm=$('input[name="lamt[]"]:eq('+i+')').parent('td'); mess="Lodging: Enter Amount";}
					else mess=1;
				}
			});
...
*/					else if($('input[name="amt[]"]:eq('+i+')').val()==''){errelm=$('input[name="amt[]"]:eq('+i+')').parent('td'); mess="Conveyance: Enter Amount";}
			...
			/* others */
			$('input[name="others[]"]').each(function(i,valuee){
				if($(this).val()!=""){ //alert($('input[name="odate[]"]:eq('+i+')').val());
					if($('input[name="odate[]"]:eq('+i+')').val()==''){errelm=$('input[name="odate[]"]:eq('+i+')').parent('td');mess="Others: Select Date";}
					//else if($('input[name="ofile[]"]:eq('+i+')').val()==''){errelm=$('input[name="ofile[]"]:eq('+i+')').parent('td');mess="Others: Select File";}
					else if($('select[name="ticket_ot[]"]:eq('+i+')').val()==''){errelm=$('select[name="ticket_ot[]"]:eq('+i+')').parent('td');mess="Others: Select Ticket Id";}
					else if($('input[name="dprNum_ot[]"]:eq('+i+')').val()==''){errelm=$('input[name="dprNum_ot[]"]:eq('+i+')').parent('td');mess="Others: Enter DPR Number";}
