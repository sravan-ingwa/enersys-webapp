...
date_default_timezone_set("Asia/Kolkata");
	...
	//9.
		...
		$zhsmail = '';
		$zhs_query = mysqli_query($mr_con,"SELECT email_id FROM ec_employee_master WHERE state_alias LIKE '%".alias($site_alias,'ec_sitemaster','site_alias','state_alias')."%' AND privilege_alias='OX5E3EMI0U' AND flag='0'");
		...
		$body.="<a href='http://enersyscare.co.in/enersyscare_V2/print_site.php?a=".$link."' target='_blank'>Print</a>";
		$body.="</th>";
		$body.="</tr>";
