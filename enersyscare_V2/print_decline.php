...
<?php
	...
	include ('mysql.php');
	//mysqli_query($mr_con,"INSERT INTO ec_jtest (alias) VALUES('".$_REQUEST['ticketAlias']."')");
		...
		$body.="<tr align='center'>";
			$body.="<th align='center' style='border:1px solid #ddd; border-bottom:1px solid #fff;'>";
				$body.="<table width='100%' style='border-bottom:1px solid #000'>";
					$body.="<tr>";
						$body.="<th align='left'>
								<img src='EnerSyslogo-print.png' alt='EnerSys_logo' height='80' width='150'>
		...
		$body.="<tr>";
			$body.="<td align='center' style='border:1px solid #ddd;'>";
				...
				$body .= "<table style='border-collapse:collapse; font-size:13px;margin-left:80px;' cellpadding='3' align='left'>
					...
					$body .= "<table style='border-collapse:collapse; font-size:13px;' cellpadding='3' align='left'>
					<tr><td>Remarks: <b>BB is not maintain properly. Float voltage stetted 54.6v instead of 54v, SMPS controller not working. BB not cobver the warranty. further service will provide on chargeable basis.</b></td></tr>
					</table><br>";
					
				$body.="<table width='100%' cellpadding='5'>";
					/*$body.="<tr>";
						$esca_efsr_link = alias($ticket_alias,'ec_tickets','ticket_alias','esca_efsr_link');
						$esca_start = alias($ticket_alias,'ec_tickets','ticket_alias','esca_start');
						$link = (!empty($esca_efsr_link) ? "images/esca_efsr/".$esca_efsr_link : (empty($esca_start) ? "enersyscare_V2":"mobile_app")."/pdf/?ticket_alias=".$ticket_alias);
						$body.="<td align='left'>For details please go through the e-FSR Enclosed <a href='http://enersyscare.co.in/".$link."' target='_blank'>Click here</a></td>";
					$body.="</tr>";*/
					$body.="<tr>";
					...
					$body.="<tfoot>";
						$body.="<tr>";
							$body.="<td align='center' style='padding:8px;'>
							         <p class='ener-foot'>Registered Office : Plot No: 1057M, 1st floor, Road #45, Jubilee Hills, Hyderabad - 500033 Telangana, India, Ph : +91 40 67046701 Fax : +91 40 67046700 E-Mail : service@enersys.co.in</p>
									</td>";
						$body.="</tr>";
					$body.="</tfoot>";
				$body.="</table>";
