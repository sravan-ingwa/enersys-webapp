...
$resultz=expensefullView($alias);
	if($resultz!=""){
		...
		$download1.="<table class='cont_2' ><tr><td>(".employeeDetails('name',$resultz[0]['employee_alias']).")<br><b>Client Signature</b>";
		$download1.='</td><td align="center"><p style=\"font-style: italic;font-size:12px;\">Page No : {PAGENO}/{nbpg}</p></td><td align="right">('.hodname($resultz[0]['employee_alias']).')<br><b>HOD Signature</b></td></tr></table>';
		$download.="</tr></table>";
		}
