		...
		$download='<html><body><table class="table1">
				...
				$download.="</table>";
					...
					if(mysqli_num_rows($sql1)){$cap_arr=array();
						...
						$download1.='<td>'.checkemptydash(($row1['ocv']=='0.000' ? '' : $row1['ocv'])).'</td>';
						$download1.='<td>'.checkemptydash(($row1['dis_current']=='0.00' ? '' : $row1['dis_current'])).'</td>';
						$download1.='<td>'.checkemptydash(($row1['1hr']=='0.00' ? '' : $row1['1hr'])).'</td>';
						$download1.='<td>'.checkemptydash(($row1['2hr']=='0.00' ? '' : $row1['2hr'])).'</td>';
						$download1.='<td>'.checkemptydash(($row1['3hr']=='0.00' ? '' : $row1['3hr'])).'</td>';
						$download1.='<td>'.checkemptydash(($row1['4hr']=='0.00' ? '' : $row1['4hr'])).'</td>';
						$download1.='<td>'.checkemptydash(($row1['5hr']=='0.00' ? '' : $row1['5hr'])).'</td>';
						$download1.='<td>'.checkemptydash(($row1['6hr']=='0.00' ? '' : $row1['6hr'])).'</td>';
						$download1.='<td>'.checkemptydash(($row1['7hr']=='0.00' ? '' : $row1['7hr'])).'</td>';
						$download1.='<td>'.checkemptydash(($row1['8hr']=='0.00' ? '' : $row1['8hr'])).'</td>';
						$download1.='<td>'.checkemptydash(($row1['9hr']=='0.00' ? '' : $row1['9hr'])).'</td>';
						$download1.='<td>'.checkemptydash(($row1['10hr']=='0.00' ? '' : $row1['10hr'])).'</td>';
