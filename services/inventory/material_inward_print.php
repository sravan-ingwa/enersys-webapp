...
$sql = mysqli_query($mr_con,"SELECT from_type, inv_num, from_wh, to_wh, date_of_trans, totalamount, list_items, transport, docket, dispatch_date, ref_no, alias, trans_id FROM ec_material_inward WHERE alias ='$alias' AND flag=0");
		...
		<tr>
			<td>
				...
				<table class="cont_3">
					<tr>
						<td align="left"><h3>'.strtoupper($heading).'</h3></td>
					</tr>
				</table>';
				...
				$print.="<tr>";
					...
					$print.="<td>";
						$print.="<h4>TO W/H</h4>";
						$print.="<p>".checkempty(ucfirst(strtolower(alias($row['to_wh'],'ec_warehouse','wh_alias','wh_code'))))."</p>";
					$print.="</td>";
				$print.="</tr>";
				$print.="<tr>";
					$print.="<td>";
						$print.="<h4>INWARD NUMBER</h4>";
						$print.="<p>".checkempty(ucfirst(strtolower($row['inv_num'])))."</p>";
					$print.="</td>";
					$print.="<td>";
						$print.="<h4>TOTAL MATERIAL VALUE</h4>";
						$print.="<p>".checkempty(strtolower($row['totalamount']))."</p>";
					$print.="</td>";
				$print.="</tr>";
				$print.="<tr>";
					$print.="<td>";
						$print.="<h4>MRF NUMBER</h4>";
						$print.="<p>".checkempty($mrf_number)."</p>";
					$print.="</td>";
					$print.="<td>";
						$print.="<h4>SJO NUMBER</h4>";
						$print.="<p>".checkempty($sjo_number)."</p>";
					$print.="</td>";
				$print.="</tr>";
				$print.="<tr>";
					$print.="<td>";
					...
					$print.="<td>";
						...
						$print.="<p>".ucfirst(strtolower($row['docket']))."</p>";
					$print.="</td>";
				$print.="</tr>";
			$print.="</table><br/>";
				...
				$print.='<p class="single_record"></p>';
					...
					if(mysqli_num_rows($sql1)){
						...
						$i=0;while($row1=mysqli_fetch_array($sql1)){
							...
							$print.='<td>'.checkempty(($wname=='2609' ? 'BUFFER' : alias($wname,'ec_warehouse','wh_alias','wh_code'))).'</td>';
