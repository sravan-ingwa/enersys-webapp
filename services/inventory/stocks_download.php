...
$sql=mysqli_query($mr_con,"SELECT * FROM ec_item_code WHERE item_code_alias='$alias' AND flag=0");
		...
		$download='<html><body><table>
				...
				$download.="<table width='100%' class='simp'>";
					...
					$download.="<tr>";
						...
						$download.="</td>";
						$download.="<td>";
							$download.="<h4>INVOICE / NRDC NUMBER</h4>";
							$download.="<p>".checkempty(ucfirst(strtoupper($row['invoice_no'])))."</p>";
						$download.="</td>";
					$download.="</tr>";
					$download.="<tr>";
						$download.="<td>";
							$download.="<h4>INVOICE DATE</h4>";
							$download.="<p>".checkempty(ucfirst(strtoupper(dateFormat($row['invoice_date'],"d"))))."</p>";
						$download.="</td>";
						$download.="<td>";
							$download.="<h4>FACTORY CONDITION</h4>";
							$download.="<p>".checkempty(get_cell_type($row['cell_type']))."</p>";
						$download.="</td>";
					$download.="</tr>";
				$download.="</table>";
				...
				$download.="<table width='100%' class='simp'>";
					...
					$download.="<td>";
							$download.="<h4>ITEM CODE</h4>";
							$download.="<p>".strtoupper(alias($row['item_code'],'ec_accessories','accessories_alias','accessory_description'))."</p>";
						$download.="</td>";
					$download.="</tr>";
					$download.="<tr>";
					...
					$download.="<tr>";
						$download.="<td>";
							$download.="<h4>INVOICE DATE</h4>";
							$download.="<p>".checkempty(ucfirst(dateFormat($row['invoice_date'],"d")))."</p>";
						$download.="</td>";
						$download.="<td>";
							$download.="<h4>FACTORY CONDITION</h4>";
							$download.="<p>".checkempty(get_cell_type($row['cell_type']))."</p>";
	...
	$filename='Stocks_'.date('d-m-Y_H_i_s');
