		...
		<tr>
			<td class="td1">
				...
				<table class="cont_3">
					...
					<table class="cont_2">
						<tr>
							<td width="33.33%"><h3>'.strtoupper('Sale PO Number').'</h3><p>'.checkempty(ucfirst($row['po_num'])).'</p></td>
							<td width="33.33%"><h3>'.strtoupper('Sale Invoice Number').'</h3><p>'.checkempty(ucfirst($row['sale_invoice_num'])).'</p></td>
							<td width="33.33%"><h3>'.strtoupper('Sale Invoice Date').'</h3><p>'.dateFormat($row['sale_invoice_date'],'d').'</p></td>
						</tr>
					</table>
					<table class="cont_2">
						<tr>
