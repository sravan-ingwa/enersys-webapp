...
$heading = 'SITE STATUS';
$query = mysqli_query($mr_con,"SELECT * FROM  ec_site_status WHERE site_status_alias='$alias' AND flag='0'");
if(mysqli_num_rows($query)){
	...
	<table class="table1">
		<tr>
			...
			<table class="cont_3">
				<tr>
					<td align="left"><h3>'.strtoupper("SITE STATUS DETAILS").'</h3></td>
				</tr>
			</table>
				<table class="cont_2">
					<tr>
						<td width="33.33%"><h3>'.strtoupper('Site Status').'</h3><p>'.checkempty(ucfirst($row['site_status'])).'</p></td>
						<td width="33.33%"></td>
						<td width="33.33%"></td>
					</tr>
				</table>';
