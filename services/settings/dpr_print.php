...
$heading = 'DPR Category';
$query = mysqli_query($mr_con,"SELECT * FROM  ec_dpr_category WHERE category_alias='$alias' AND flag='0'");
if(mysqli_num_rows($query)){
	...
	<table class="table1">
		<tr>
			...
			<table class="cont_3">
				<tr>
					<td align="left"><h3>'.strtoupper("DPR DETAILS").'</h3></td>
				</tr>
			</table>
				<table class="cont_2">
					<tr>
						<td width="33.33%"><h3>'.strtoupper('DPR Category').'</h3><p>'.checkempty(ucfirst($row['category'])).'</p></td>
						<td width="33.33%"></td>
						<td width="33.33%"></td>
					</tr>
				</table>';
