	...
	<table class="table1">
		<tr>
			<td class="td1">
				...
				<table class="cont_3">
					<tr>
						<td align="left"><h3>'.strtoupper("ASSETS DETAILS").'</h3></td>
					</tr>
				</table>
				
					<table class="cont_2">
						<tr>
							<td width="33.33%"><h3>'.strtoupper('Asset Type').'</h3><p>'.checkempty(ucfirst($row['asset_type'])).'</p></td>
							<td width="33.33%"><h3>'.strtoupper('Asset Name').'</h3><p>'.checkempty(ucfirst($row['asset_name'])).'</p></td>
							<td width="33.33%"><h3>'.strtoupper('Asset Make').'</h3><p>'.checkempty(ucfirst($row['asset_make'])).'</p></td>
						</tr>
					</table>
					<table class="cont_2">
						<tr>
							<td width="33.33%"><h3>'.strtoupper('Asset Serial Number').'</h3><p>'.checkempty(ucfirst($row['asset_serial_number'])).'</p></td>
							<td width="33.33%"><h3>'.strtoupper('specification').'</h3><p>'.checkempty(ucfirst($row['specification'])).'</p></td>
							<td width="33.33%"><h3>'.strtoupper('Nature Of Asset').'</h3><p>'.checkempty(ucfirst($row['nature_of_asset'])).'</p></td>
					...
					$print.='<table class="cont_2">
						<tr>
							<td width="33.33%"><h3>'.strtoupper('Calibration Date').'</h3><p>'.dateFormat(ucfirst($row['calibration_date']),'d').'</p></td>
							<td width="33.33%"><h3>'.strtoupper('Calibration Due Date').'</h3><p>'.dateFormat(ucfirst($row['calibration_due_date']),'d').'</p></td>
