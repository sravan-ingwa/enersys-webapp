	...
	<table class="table1">
		<tr>
			<td class="td1">
				...
				<table class="cont_3">
					<tr>
						<td align="left"><h3>'.strtoupper("PRODUCT DETAILS").'</h3></td>
					</tr>
				</table>
					<table class="cont_2">
						<tr>
							<td width="33.33%"><h3>'.strtoupper('Product Description').'</h3><p>'.checkempty(ucfirst($row['product_description'])).'</p></td>
							<td width="33.33%"><h3>'.strtoupper('Battery Rating').'</h3><p>'.checkempty(ucfirst($row['battery_rating'])).'</p></td>
							<td width="33.33%"><h3>'.strtoupper('Cell Voltage').'</h3><p>'.checkempty(strtolower($row['cell_voltage'])).'</p></td>
						</tr>
					</table>
					<table class="cont_2">
						<tr>
							<td width="33.33%"><h3>'.strtoupper('Item Code').'</h3><p>'.checkempty(ucfirst($row['item_code'])).'</p></td>
							<td width="33.33%"><h3>'.strtoupper('price').'</h3><p>'.checkempty(ucfirst($row['price'])).'</p></td>
							<td width="33.33%"><h3>'.strtoupper('Weight').'</h3><p>'.checkempty(ucfirst($row['weight'])).'</p></td>
						</tr>
					</table>';
		$print.='</td>
			</tr>
