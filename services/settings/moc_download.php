...
$heading = 'MOC';
$query = mysqli_query($mr_con,"SELECT * FROM  ec_moc WHERE moc_alias='$alias' AND flag='0'");
if(mysqli_num_rows($query)){
		...
		<tr>
			<td class="td1">
				...
				<table class="cont_3">
					...
					<table class="cont_2">
						<tr>
							<td width="33.33%"><h3>MOC NAME</h3><p>'.checkempty(strtoupper($row['moc_name'])).'</p></td>
							<td width="33.33%"></td>
							<td width="33.33%"></td>
						</tr>
					</table>';
	...
	$filename='MOCdetails_'.date('d-m-Y_H_i_s');
