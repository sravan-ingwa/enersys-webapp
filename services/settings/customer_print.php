...
if(mysqli_num_rows($query)){
	...
	<table class="table1">
		<tr>
			...
			<table class="cont_3">
				<tr>
					<td align="left"><h3>'.strtoupper("CUSTOMER DETAILS").'</h3></td>
				</tr>
			</table>
				<table class="cont_2">
					<tr>
						<td width="33.33%"><h3>'.strtoupper('Customer Name').'</h3><p>'.checkempty(ucfirst($row['customer_name'])).'</p></td>
						<td width="33.33%"><h3>'.strtoupper('Customer Code').'</h3><p>'.checkempty(ucfirst($row['customer_code'])).'</p></td>
						<td width="33.33%"><h3>'.strtoupper('Customer Email').'</h3><p>'.checkempty(strtolower($row['customer_email'])).'</p></td>
					</tr>
				</table>
				<table class="cont_2">
					<tr>
						<td width="33.33%"><h3>'.strtoupper('Customer Contact').'</h3><p>'.checkempty(ucfirst($row['customer_contact'])).'</p></td>
						<td width="33.33%"><h3>'.strtoupper('Dispatch Months').'</h3><p>'.checkempty(ucfirst($row['dispatch'])).'</p></td>
						<td width="33.33%"><h3>'.strtoupper('Installation Months').'</h3><p>'.checkempty(ucfirst($row['installation'])).'</p></td>
					</tr>
				</table>
				<table class="cont_2">
					<tr>
						...
						<td width="33.33%"><h3>'.strtoupper('Schedule').'</h3><p>'.checkempty(ucfirst($row['schedule'])).'</p></td>
					</tr>
				</table>
				<table class="cont_2">
					<tr>
