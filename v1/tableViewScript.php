...
function inptfield($fv1,$fv2){
	...
	switch ($fv1) {
		case errorMessage: return ("<select onchange='xyz()' name='".$fv1."'>".ticketStat()."</select>");break;
		...
		case createdDate: return ("<input  type='text' id='datepicker'  ".$fv2." class='singleDateEnd' name='".$fv1."'>");
