...
(function ($) {
  ...
  $.fn.extend({
    popConfirm: function (options) {
      var defaults = {
          title: '<style="text-align:center">Delete</style>',
      ...
      return this.each(function () {
        ...
        self.popover({
          ...
          content: options.content + '<p class="button-group" style="margin-top: 10px; text-align: center;"><button type="button" style="margin-right:10px;" class="btn btn-small btn-danger confirm-dialog-btn-confirm">' + options.yesBtn + '</button><button type="button" class="btn btn-small confirm-dialog-btn-abord">' + options.noBtn + '</button></p>'
        }).blur(function (e) {
          if (last && last !== self) {
