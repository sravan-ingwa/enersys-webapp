...
$(function(){
    ...
    function ajaxSelect(id, type) {
        ...
        if (type == "Circle") {
            ...
            $("#ajaxSelect_EmployeeName").html("<option value='' disabled='disabled'>Select EmployeeName</option>");
    ...
    function ajaxText(id,type){
        if(id!=""){
            ...
            $.ajax({
                ...
                success: function(result){
                    switch(type){
                        case 'District':$("#ajaxText_"+type).html("<option value=''>Select Base Location</option>"); $("#ajaxText_"+type).append(result);break;
                        default:$("#ajaxText_"+type).autocomplete('ajaxText.php?result='+result+'&type='+type+'&ref=autocomplete', {selectFirst: true});
                        }
                   }
            });
        }
        if(type=="Circle"){document.getElementById("ajaxText_Circle").value = "";document.getElementById("ajaxText_Cluster").value = "";$("#ajaxText_District").html("<option value=''>Select Base Location</option>");}if(type=="Cluster"){document.getElementById("ajaxText_Cluster").value = "";$("#ajaxText_District").html("<option value=''>Select Base Location</option>");}if(type=="District"){$("#ajaxText_District").html("<option value='' >Select Base Location</option>");}	
    }
