...
if(isset($_REQUEST['update'])){
			...
			if($extension == "pdf"){
				if($_FILES["pdf"]["error"] > 0){echo "Return Code: ".$_FILES["pdf"]["error"]."<br/>";}
					...
					if (file_exists("../reports/revival/".$name)){echo "<script>alert('".$name." already exists')</script>";}
						...
						if(isset($_REQUEST['oldPdf'])){@unlink("../reports/revival/".$_REQUEST['oldPdf']);}				
					}
				}
	...
	elseif($g[$j]==""){$result="Enter disCurrent";}
	...
	elseif($r[$j]==""){$result="Enter 11Hr";}
		...
		$RefId = $_REQUEST['y'];
		$ac = mysql_query("UPDATE ss_revival SET mrfNumber='$aa', noOfCells='$a',capacity='$b',pdf='$c',srNo='$d[$j]',cellSrNo='$e[$j]',ocv='$f[$j]',disCurrent='$g[$j]',1Hr='$h[$j]',2Hr='$i[$j]',3Hr='$ij[$j]',4Hr='$k[$j]',5Hr='$l[$j]',6Hr='$m[$j]',7Hr='$n[$j]',8Hr='$o[$j]',9Hr='$p[$j]',10Hr='$q[$j]',result='$r[$j]' WHERE id='$RefId' AND srNo='$d[$j]'");
	}
...
$RefId =$_REQUEST['y'];
$query=mysql_query("SELECT * FROM ss_revival WHERE id='$RefId' GROUP BY capacity");
...
<div class="col-md-4 form-group">
    ...
    <input tabindex="1" class="form-control" type="text" name="mrfNumber" value="<?php echo $row['mrfNumber']; ?>" placeholder="MRF Number" readonly />
</div>
<div class="col-md-4 form-group">
...
<div class="col-md-4 form-group">
    ...
    <a href="../reports/revival/<?php echo $row['pdf'];?>" tabindex="5" target="_blank" class="form-control" readonly style="cursor:pointer; font-weight:bold">Click Here</a>
</div>
<div class="col-md-4 form-group">
    ...
    <div class="row clearfix">
		<div class="col-md-11 column">
			<table class="table table-bordered table-hover" id="tab_logic">
                ...
                <tbody>
                	<?php $query1 = mysql_query("SELECT * FROM ss_revival WHERE capacity='$row[capacity]'");
					 while($row1 = mysql_fetch_array($query1)){ ?>
                    <tr>
						<td width="60px"><input type="text"  tabindex="" class="form-control" name="srNo[]" value="<?php echo $row1['srNo']; ?>" readonly /></td>
						<td width="95px"><input type="text"  tabindex="<?php echo $i+3; ?>" class="form-control" name="cellSrNo[]" value="<?php echo $row1['cellSrNo']; ?>" placeholder="Cell Sr. No."></td>
						<td><input type="text"  tabindex="<?php echo $i+3; ?>" class="form-control" name="ocv[]" value="<?php echo $row1['ocv']; ?>" placeholder="OCV"></td>
						<td><input type="text"  tabindex="<?php echo $i+3; ?>" class="form-control" name="disCurrent[]" value="<?php echo $row1['disCurrent']; ?>" placeholder="Discharge Current"></td>
                        <td><input type="text"  tabindex="<?php echo $i+3; ?>" class="form-control" name="1Hr[]" value="<?php echo $row1['1Hr']; ?>" placeholder="1st"></td>
                        <td><input type="text"  tabindex="<?php echo $i+3; ?>" class="form-control" name="2Hr[]" value="<?php echo $row1['2Hr']; ?>" placeholder="2nd"></td>
                        <td><input type="text"  tabindex="<?php echo $i+3; ?>" class="form-control" name="3Hr[]" value="<?php echo $row1['3Hr']; ?>" placeholder="3rd"></td>
                        <td><input type="text"  tabindex="<?php echo $i+3; ?>" class="form-control" name="4Hr[]" value="<?php echo $row1['4Hr']; ?>" placeholder="4th"></td>
                        <td><input type="text"  tabindex="<?php echo $i+3; ?>" class="form-control" name="5Hr[]" value="<?php echo $row1['5Hr']; ?>" placeholder="5th"></td>
                        <td><input type="text"  tabindex="<?php echo $i+3; ?>" class="form-control" name="6Hr[]" value="<?php echo $row1['6Hr']; ?>" placeholder="6th"></td>
                        <td><input type="text"  tabindex="<?php echo $i+3; ?>" class="form-control" name="7Hr[]" value="<?php echo $row1['7Hr']; ?>" placeholder="7th"></td>
                        <td><input type="text"  tabindex="<?php echo $i+3; ?>" class="form-control" name="8Hr[]" value="<?php echo $row1['8Hr']; ?>" placeholder="8th"></td>
                        <td><input type="text"  tabindex="<?php echo $i+3; ?>" class="form-control" name="9Hr[]" value="<?php echo $row1['9Hr']; ?>" placeholder="9th"></td>
                        <td><input type="text"  tabindex="<?php echo $i+3; ?>" class="form-control" name="10Hr[]" value="<?php echo $row1['10Hr']; ?>" placeholder="10th"></td>
                        <td width="95px"><select tabindex="<?php echo $i+3; ?>" class="form-control" name="result[]"><option value="pass" <?php echo ($row1['result']=='pass' ? 'selected':''); ?>>Pass</option>
...
<div class="form-group col-xs-12 morpad">
    <div class="col-xs-12">
    <button tabindex="19" type="submit" class="btn btn-primary ss_buttons" name="update">Update</button>
    <button tabindex="20" type="reset" class="btn btn-primary ss_buttons" name="reset">Reset</button>
    </div>
</div>
</form>