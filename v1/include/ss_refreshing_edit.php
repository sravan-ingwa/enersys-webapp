		...
		<div class="col-md-11 column">
			<table class="table table-bordered table-hover" id="tab_logic">
                ...
                <tbody>
                    ...
                    <tr>
						<td width="60px"><input type="text"  tabindex="4" class="form-control" name="srNo[]" value="<?php echo $row1['srNo']; ?>" readonly /></td>
						<td width="95px"><input type="text"  tabindex="5" class="form-control" name="cellSrNo[]" value="<?php echo $row1['cellSrNo']; ?>" placeholder="Cell Sr. No." ></td>
						<td><input type="text"  tabindex="6" class="form-control" name="ocv[]" value="<?php echo $row1['ocv']; ?>" placeholder="OCV" ></td>
						<td><input type="text"  tabindex="7" class="form-control" name="disCurrent[]" value="<?php echo $row1['disCurrent']; ?>" placeholder="Charging Current" ></td>
                        <td><input type="text"  tabindex="8" class="form-control" name="1Hr[]" value="<?php echo $row1['1Hr']; ?>" placeholder="1st" ></td>
                        <td><input type="text"  tabindex="9" class="form-control" name="2Hr[]" value="<?php echo $row1['2Hr']; ?>" placeholder="2nd" ></td>
                        <td><input type="text"  tabindex="10" class="form-control" name="3Hr[]" value="<?php echo $row1['3Hr']; ?>" placeholder="3rd" ></td>
                        <td><input type="text"  tabindex="11" class="form-control" name="4Hr[]" value="<?php echo $row1['4Hr']; ?>" placeholder="4th" ></td>
                        <td><input type="text"  tabindex="12" class="form-control" name="5Hr[]" value="<?php echo $row1['5Hr']; ?>" placeholder="5th" ></td>
                        <td><input type="text"  tabindex="13" class="form-control" name="6Hr[]" value="<?php echo $row1['6Hr']; ?>" placeholder="6th" ></td>
                        <td><input type="text"  tabindex="14" class="form-control" name="7Hr[]" value="<?php echo $row1['7Hr']; ?>" placeholder="7th" ></td>
                        <td><input type="text"  tabindex="15" class="form-control" name="8Hr[]" value="<?php echo $row1['8Hr']; ?>" placeholder="8th" ></td>
                        <td><input type="text"  tabindex="16" class="form-control" name="9Hr[]" value="<?php echo $row1['9Hr']; ?>" placeholder="9th" ></td>
                        <td><input type="text"  tabindex="17" class="form-control" name="10Hr[]" value="<?php echo $row1['10Hr']; ?>" placeholder="10th" ></td>
