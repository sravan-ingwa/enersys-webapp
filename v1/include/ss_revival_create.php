...
<div class="col-md-3 form-group">
    <label>MRF(Material Request Form) Number : </label>
     <select class="selectpicker form-control" autofocus="autofocus" name="mrfNumber" tabindex="1" data-live-search="true" onchange="ajaxRevivRefreshCust('revival',this.value);">
		...
		<div class="col-md-11 column">
			<table class="table table-bordered table-hover" id="tab_logic">
                ...
                <tbody id="revivalRows">
					<?php for($i=1;$i<=1;$i++){ ?>
                	<tr>
						<td width="60px"><input type="text" tabindex="" class="form-control" name="srNo[]"  value="1" readonly /></td>
						<td width="95px"><input type="text" tabindex="<?php echo $i+5; ?>" class="form-control" name="cellSrNo[]" placeholder="Cell Sr. No." ></td>
						<td><input type="text" tabindex="<?php echo $i+5; ?>" class="form-control" name="ocv[]" placeholder="OCV" ></td>
						<td><input type="text" tabindex="<?php echo $i+5; ?>" class="form-control" name="disCurrent[]" placeholder="Current" ></td>
                        <td><input type="text" tabindex="<?php echo $i+5; ?>" class="form-control" name="1Hr[]" placeholder="1st" ></td>
                        <td><input type="text" tabindex="<?php echo $i+5; ?>" class="form-control" name="2Hr[]" placeholder="2nd" ></td>
                        <td><input type="text" tabindex="<?php echo $i+5; ?>" class="form-control" name="3Hr[]" placeholder="3rd" ></td>
                        <td><input type="text" tabindex="<?php echo $i+5; ?>" class="form-control" name="4Hr[]" placeholder="4th" ></td>
                        <td><input type="text" tabindex="<?php echo $i+5; ?>" class="form-control" name="5Hr[]" placeholder="5th" ></td>
                        <td><input type="text" tabindex="<?php echo $i+5; ?>" class="form-control" name="6Hr[]" placeholder="6th" ></td>
                        <td><input type="text" tabindex="<?php echo $i+5; ?>" class="form-control" name="7Hr[]" placeholder="7th" ></td>
                        <td><input type="text" tabindex="<?php echo $i+5; ?>" class="form-control" name="8Hr[]" placeholder="8th" ></td>
                        <td><input type="text" tabindex="<?php echo $i+5; ?>" class="form-control" name="9Hr[]" placeholder="9th" ></td>
                        <td><input type="text" tabindex="<?php echo $i+5; ?>" class="form-control" name="10Hr[]" placeholder="10th" ></td>
                        <td width="95px"><select tabindex="<?php echo $i+5; ?>" class="form-control" name="result[]"><option value="pass">Pass</option><option value="fail">Fail</option></select></td>
					</tr>
					<?php } ?>
				</tbody>
			</table>
