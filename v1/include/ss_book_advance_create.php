...
if(isset($_REQUEST['Create'])){
	...
	elseif($g==""){$result="Select Year";}
		...
		if($ac)$result="".errorMsg('ERRMSG008')."<script>setTimeout(function(){ document.location = 'index.php?x=".$_REQUEST['x']."';}, 1000 ); </script>";else $result=errorMsg('ERRMSG002');
	}
}
?>
...
<div class="col-md-4 form-group">
    ...
    <?php $sql = mysql_query("SELECT * FROM ss_employee_details WHERE email='".$_SESSION['login_user']."'");
