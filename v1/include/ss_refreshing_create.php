...
if(isset($_REQUEST['Create'])){
	$id = checkx(rand(0000, 9999),'ss_refreshing');
	...
	elseif($i[$j]==""){$result="Enter Charging Current";}
	...
	elseif($t[$j]==""){$result="Enter 11Hr";}
		...
		$ac = mysql_query("INSERT INTO ss_refreshing(id,mrfNumber,custName,noOfCells,capacity,pdf,engName,srNo,cellSrNo,ocv,disCurrent,1Hr,2Hr,3Hr,4Hr,5Hr,6Hr,7Hr,8Hr,9Hr,10Hr,result,flag) VALUES('$id','$a','$b','$c','$d','$aa','$e','$f[$j]','$g[$j]','$h[$j]','$i[$j]','$ij[$j]','$k[$j]','$l[$j]','$m[$j]','$n[$j]','$o[$j]','$p[$j]','$q[$j]','$r[$j]','$s[$j]','$t[$j]','0')");
		}
	}
...
<div class="col-md-3 form-group">
    <label>MRF(Material Request Form) Number : </label>
     <select class="selectpicker form-control" name="mrfNumber" tabindex="1" data-live-search="true" onchange="ajaxRevivRefreshCust('refreshing',this.value);">
...
<div class="col-md-3 form-group">
    ...
    <input tabindex="2" class="form-control" type="text" name="custName" id="refreshing" placeholder="Customer Name" readonly/>
</div>
<div class="col-md-3 form-group">
...
<div class="col-md-1 form-group">
    <label>Click : </label>
    <input type="button" tabindex="5" class="form-control" value="+" id="revivalClick">
</div>
<div class="container">
		...
		<div class="col-md-11 column">
			<table class="table table-bordered table-hover" id="tab_logic">
                ...
                <tbody id="revivalRows">
					<?php for($i=1;$i<=1;$i++){ ?>
                	<tr>
						<td width="60px"><input type="text" tabindex="<?php echo $i+3; ?>" class="form-control" name="srNo[]"  value="1" readonly /></td>
						<td width="95px"><input type="text" tabindex="<?php echo $i+3; ?>" class="form-control" name="cellSrNo[]" placeholder="Cell Sr. No." ></td>
						<td><input type="text" tabindex="<?php echo $i+3; ?>" class="form-control" name="ocv[]" placeholder="OCV" ></td>
						<td><input type="text" tabindex="<?php echo $i+3; ?>" class="form-control" name="disCurrent[]" placeholder="Current" ></td>
                        <td><input type="text" tabindex="<?php echo $i+3; ?>" class="form-control" name="1Hr[]" placeholder="1st" ></td>
                        <td><input type="text" tabindex="<?php echo $i+3; ?>" class="form-control" name="2Hr[]" placeholder="2nd" ></td>
                        <td><input type="text" tabindex="<?php echo $i+3; ?>" class="form-control" name="3Hr[]" placeholder="3rd" ></td>
                        <td><input type="text" tabindex="<?php echo $i+3; ?>" class="form-control" name="4Hr[]" placeholder="4th" ></td>
                        <td><input type="text" tabindex="<?php echo $i+3; ?>" class="form-control" name="5Hr[]" placeholder="5th" ></td>
                        <td><input type="text" tabindex="<?php echo $i+3; ?>" class="form-control" name="6Hr[]" placeholder="6th" ></td>
                        <td><input type="text" tabindex="<?php echo $i+3; ?>" class="form-control" name="7Hr[]" placeholder="7th" ></td>
                        <td><input type="text" tabindex="<?php echo $i+3; ?>" class="form-control" name="8Hr[]" placeholder="8th" ></td>
                        <td><input type="text" tabindex="<?php echo $i+3; ?>" class="form-control" name="9Hr[]" placeholder="9th" ></td>
                        <td><input type="text" tabindex="<?php echo $i+3; ?>" class="form-control" name="10Hr[]" placeholder="10th" ></td>
                        <td width="95px"><select tabindex="<?php echo $i+3; ?>" class="form-control" name="result[]"><option value="pass">Pass</option><option value="fail">Fail</option></select></td>
					</tr>
					<?php } ?>
				</tbody>
			</table>
...
<div class="col-md-4 form-group">
    ...
    <input tabindex="" type="file" class="form-control" name="pdf">
</div><div class="col-md-4 form-group">
    <label>Done By (Engineer Name) : </label>
    <input tabindex="" type="text" class="form-control" name="engName" placeholder="Engineer Name">
</div>
<div class="form-group col-xs-12 morpad">
    <div class="col-xs-12">
    <button tabindex="" type="submit" class="btn btn-primary ss_buttons" name="Create">Submit</button>
    <button tabindex="" type="reset" class="btn btn-primary ss_buttons" name="reset">Reset</button>
    </div>
</div>
</form>