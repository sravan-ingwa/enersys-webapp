<?php include('lock.php');if(isset($_SESSION['login_user'])){include('functions.php');?>
<!DOCTYPE html>
<html lang="en">
<head>
<?php TitleFav();?>
...
<link href="css/jquery-ui.css" rel="stylesheet" type="text/css" media="all" /> <!-- this is for date picker (//code.jquery.com/ui/1.11.4/themes/smoothness/)-->
<style>
		...
		<div class="panel panel-primary" style="border:none !important;">
				...
				<?php } ?>
					<?php 
                    	if(!isset($_REQUEST['x'])){
							include('welcome.php');
						}elseif($_REQUEST['x'] != 1764){
                        		include('tableViewScript.php');
                        }else{
                        	include('tableViewInvetoryBalance.php');
                        }
                    ?>
                    <?php echo $result;?>
                </div>
