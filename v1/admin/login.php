                            ...
                            <form class="form-1" action="login_script.php" method="post">
                                <div class="textbox-wrap">
                                    <div class="input-group" id="usererror">
                                        ...
                                        <input type="text" name="userId" tabindex="1" autofocus autocomplete="on" required class="form-control" style="background:transparent;" placeholder="Username" />
                                    </div>
                                </div>
                                <div class="textbox-wrap">
                                ...
                                <div class="login-form-action clearfix">
                                    <button type="reset" name="Reset" tabindex="4" class="btn btn-success pull-left blue-btn">Reset &nbsp; <i class="icon-chevron-right"></i></button>
