...
if(isset($_REQUEST['Create'])){
	...
	$cc = circleGetID($_REQUEST['circlex']);
	...
	/*$c = ucwords(mysql_escape_string($_REQUEST['siteNamex']));
	...
	$h = mysql_escape_string($_REQUEST['mfdDatex']);
	$i = mysql_escape_string($_REQUEST['installDatex']);
	$k = mysql_escape_string($_REQUEST['numBanksx']);
	$l = ucwords(mysql_escape_string($_REQUEST['CrNamex']));
	$m = mysql_escape_string($_REQUEST['CrNumx']);
	$n = customerCategoriesGetId($_REQUEST['custCategoryx']);
	$o = mysql_escape_string($_REQUEST['siteTypex']);
	$p = mysql_escape_string($_REQUEST['custNamex']);
	$s = mysql_escape_string($_REQUEST['prodCodex']);*/
