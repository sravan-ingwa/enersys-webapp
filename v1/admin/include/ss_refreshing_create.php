...
<div class="col-md-3 form-group">
    <label>MRF(Material Request Form) Number : </label>
     <select tabindex="1" autofocus="autofocus" class="selectpicker form-control" name="mrfNumber" data-live-search="true" onchange="ajaxRevivRefreshCust('refreshing',this.value);">
