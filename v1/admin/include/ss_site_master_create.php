...
if(isset($_REQUEST['Create'])){
	...
	elseif($k=="" && $l==""){$result="Select Manufactured Date OR Installation Date";}
...
<form role="form" class="ss_form" method="post" id="defaultForm">
    ...
    <div class="col-md-4 form-group">
        ...
        <input tabindex="14" type="text" class="form-control" name="customerName" placeholder="Enter Site Technician Name">
    </div>
    <div class="col-md-4 form-group">
        <label>Site Technician Number</label>
        <input tabindex="15" type="text" class="form-control" name="customerNumber" placeholder="Enter Site Technician Number">
    </div>
    <div class="col-md-4 form-group">
    	<label>Cluster Manager Name</label>
        <input tabindex="16" type="text" class="form-control" name="clusterManagerName" placeholder="Enter Cluster Manager Name">
    </div>
    <div class="col-md-4 form-group">
    	<label>Cluster Manager Number</label>
        <input tabindex="17" type="text" class="form-control" name="clusterManagerNumber" placeholder="Enter Cluster Manager Number">
    </div>
    <div class="col-md-4 form-group">
    	<label>Cluster Manager Email</label>
        <input tabindex="18" type="text" class="form-control nocap" name="clusterManagerMail" placeholder="Enter Cluster Manager Email">
    </div>
    <div class="col-md-4 form-group">
        <label>Preventive Maintenance Schedule</label>
        <input tabindex="19" type="text" class="form-control"  name="scheduleDays" readonly="readonly" id="ajaxSelect_schedule">
        
    </div>
    <div class="col-md-4 form-group">
        <label>Warranty Months</label>
        <input tabindex="20" type="text" class="form-control" name="warrantyMonths" readonly="readonly" id="ajaxSelect_warranty">
    </div>
