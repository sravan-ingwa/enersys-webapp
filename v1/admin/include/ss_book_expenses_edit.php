...
<input type="text" tabindex="1" class="form-control" autofocus="autofocus" name="circleDeductions" placeholder="Circle deductions"/>
</div>
<div class="col-md-4 form-group">
<label>Remarks By Circle: </label>
<input type="text" tabindex="2" class="form-control" name="circleRemarks" placeholder="Remarks"/>
</div>
...
<input type="text" tabindex="3" class="form-control" autofocus="autofocus" name="corporateDeductions" placeholder="Corporate deductions"/>
</div>
<div class="col-md-4 form-group">
<label>Remarks By NHS: </label>
<input type="text" tabindex="4" class="form-control" name="corporateRemarks" placeholder="Remarks"/>
</div>
<?php } ?>
...
<div class="form-group col-xs-12 morpad">
    <div class="col-xs-12">
    <button tabindex="5" type="submit" class="btn btn-primary ss_buttons" name="Update">Submit</button>
    <button tabindex="6" type="reset" class="btn btn-primary ss_buttons" name="reset">Reset</button>
	</div>
</div>
