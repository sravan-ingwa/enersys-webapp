...
<input type="hidden" name="y" value="<?php echo $RefId;?>" />
    ...
    <div class="col-md-4 form-group">
        ...
        <select tabindex="4" name="designation" class="form-control" ><option value="" disabled>[Select Designation]</option><?php explodeEdit($row['designation'],'ss_designation','designation'); ?></select>
    </div>
    <div class="col-md-4 form-group">
        <label>Employee Role</label>
        <select tabindex="5" name="employeeRole" class="form-control" ><option value="" disabled>[Select Employee Role]</option><?php explodeEdit($row['employeeRole'],'ss_employee_roles','role'); ?></select>
    </div>
	<?php if($row['designation']!='19'){ ?>
    <div class="col-md-4 form-group">
        <label>Official Email</label>
        <input tabindex="5" type="text" name="officialEmail" class="form-control nocap" value="<?php echo $row['officialEmail']; ?>">
    </div>
	<?php } ?>
    <div class="col-md-4 form-group">
        <label>Zone: </label>
