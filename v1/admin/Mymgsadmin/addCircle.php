...
if(isset($_REQUEST['submit'])){
	...
	if($a=="" || $b=="" || $c==""){$result="Enter Zone Name, Circle and Description";}
	else{
...
while($row=mysql_fetch_array($query)){
	$zone.="<option value='$row[id]'>$row[zone]</option>";	
}
                ...
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        ...
                        <form role="form" class="ss_form" method="post">
                            <div>
                                <label>Zone</label>
                                <select name="zone"><option "">[Select Zone]</option> <?php if(isset($zone))echo $zone;?></select>
                            </div>
                            <div>
                                <label>Circle</label>
                                <input type="text" name="circle" placeholder="Enter Circle">
                            </div>
                            <div>
