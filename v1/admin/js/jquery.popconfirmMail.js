/*!
 * popConfirmMail 0.4
 * http://ifnot.github.io/popConfirmMail/
 *
 ...
 * https://raw.github.com/AnaelFavre/popConfirmMail/master/LICENCE
 *
...
(function ($) {
  ...
  $.fn.extend({
    popConfirmMail: function (options) {
      var defaults = {
          title: '<style="text-align:center">Send Mail</style>',
          content: 'Enter Your Mail ID ?',
          placement: 'left',
          container: 'body',
          yesBtn: 'Send',
          noBtn: 'Cancel'
      ...
      return this.each(function () {
        ...
        self.popover({
          ...
          content: options.content + '<div><input type="text" class="form-control" id="send"></div><p class="button-group" style="margin-top: 10px; text-align: center;"><button type="button" style="margin-right:10px;" class="btn btn-small btn-primary confirm-dialog-btn-confirm">' + options.yesBtn + '</button><button type="button" class="btn btn-small confirm-dialog-btn-abord">' + options.noBtn + '</button></p>'
        }).blur(function (e) {
          if (last && last !== self) {
            last.popover('hide').removeClass('popConfirmMail-active');
          }
          last = self;
        });
        ...
        self.bind('click', function (e) {
          ...
          $('.popConfirmMail-active').not(self).popover('hide').removeClass('popConfirmMail-active');
          self.popover('show').addClass('popConfirmMail-active');
          ...
          $(document).find('.popover .confirm-dialog-btn-confirm').bind('click', function (e) {
            ...
            self.popover('hide').removeClass('popConfirmMail-active');
          });
